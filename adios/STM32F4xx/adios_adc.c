//! \defgroup ADIOS_ADC
//!
//! ADC driver for ADIOS - STM32F4xx
//!
...
//! ADIOS_ADC_OVERSAMPLING_RATE is therefore honoured by accumulating in the
...
#if !defined(ADIOS_USE_ADC0) && !defined(ADIOS_USE_ADC1) && !defined(ADIOS_USE_ADC2)
# error "ADIOS_USE_ADC is set, but no ADC port was selected. Define ADIOS_USE_ADC0 for ADC1, ADIOS_USE_ADC1 for ADC2, ADIOS_USE_ADC2 for ADC3."
#elif defined(ADIOS_USE_ADC1) && !defined(ADC2)
# error "ADIOS_USE_ADC1 (ADC2) requested, but this STM32F4 has only ADC1. A second ADC exists on F405/F407/F415/F417/F427/F429/F437/F439/F446/F469/F479 only."
#elif defined(ADIOS_USE_ADC2) && !defined(ADC3)
# error "ADIOS_USE_ADC2 (ADC3) requested, but this STM32F4 has only ADC1. A third ADC exists on F405/F407/F415/F417/F427/F429/F437/F439/F446/F469/F479 only."
#else
...
#if defined(ADIOS_USE_ADC0) && (ADIOS_ADC0_CHANNEL_MASK & ~0x0000ffff)
# error "ADIOS_ADC0_CHANNEL_MASK selects a channel above 15. On STM32F4 the external inputs are channels 0..15; 16, 17 and 18 are the temperature sensor, VREFINT and VBAT."
#endif
#if defined(ADIOS_USE_ADC1) && (ADIOS_ADC1_CHANNEL_MASK & ~0x0000ffff)
# error "ADIOS_ADC1_CHANNEL_MASK selects a channel above 15. On STM32F4 the external inputs are channels 0..15."
#endif
#if defined(ADIOS_USE_ADC2) && (ADIOS_ADC2_CHANNEL_MASK & ~0x0000ffff)
# error "ADIOS_ADC2_CHANNEL_MASK selects a channel above 15. On STM32F4 the external inputs are channels 0..15."
#endif

#if defined(ADIOS_USE_ADC0) && !ADIOS_ADC0_CHANNEL_MASK
# warning "ADIOS_USE_ADC0 is set but ADIOS_ADC0_CHANNEL_MASK is 0: ADC1 will be initialised and convert nothing."
#endif
#if defined(ADIOS_USE_ADC1) && !ADIOS_ADC1_CHANNEL_MASK
# warning "ADIOS_USE_ADC1 is set but ADIOS_ADC1_CHANNEL_MASK is 0: ADC2 will be initialised and convert nothing."
#endif
#if defined(ADIOS_USE_ADC2) && !ADIOS_ADC2_CHANNEL_MASK
# warning "ADIOS_USE_ADC2 is set but ADIOS_ADC2_CHANNEL_MASK is 0: ADC3 will be initialised and convert nothing."
#endif
...
#define ADIOS_ADC_CLOCK_SOURCE LL_ADC_CLOCK_SYNC_PCLK_DIV4
#endif
...
#define ADIOS_ADC_SAMPLINGTIME LL_ADC_SAMPLINGTIME_144CYCLES
#endif
...
#ifndef ADIOS_ADC0_DMA_STREAM
#define ADIOS_ADC0_DMA_STREAM   LL_DMA_STREAM_0
#define ADIOS_ADC0_DMA_CHANNEL  LL_DMA_CHANNEL_0
#define ADIOS_ADC0_DMA_IRQn     DMA2_Stream0_IRQn
#define ADIOS_ADC0_DMA_IRQ_FUNC void DMA2_Stream0_IRQHandler(void)
#define ADIOS_ADC0_DMA_CLEAR()  do { LL_DMA_ClearFlag_TC0(DMA2); LL_DMA_ClearFlag_TE0(DMA2); LL_DMA_ClearFlag_HT0(DMA2); LL_DMA_ClearFlag_DME0(DMA2); LL_DMA_ClearFlag_FE0(DMA2); } while(0)
#endif

#ifndef ADIOS_ADC1_DMA_STREAM
#define ADIOS_ADC1_DMA_STREAM   LL_DMA_STREAM_2
#define ADIOS_ADC1_DMA_CHANNEL  LL_DMA_CHANNEL_1
#define ADIOS_ADC1_DMA_IRQn     DMA2_Stream2_IRQn
#define ADIOS_ADC1_DMA_IRQ_FUNC void DMA2_Stream2_IRQHandler(void)
#define ADIOS_ADC1_DMA_CLEAR()  do { LL_DMA_ClearFlag_TC2(DMA2); LL_DMA_ClearFlag_TE2(DMA2); LL_DMA_ClearFlag_HT2(DMA2); LL_DMA_ClearFlag_DME2(DMA2); LL_DMA_ClearFlag_FE2(DMA2); } while(0)
#endif

#ifndef ADIOS_ADC2_DMA_STREAM
#define ADIOS_ADC2_DMA_STREAM   LL_DMA_STREAM_1
#define ADIOS_ADC2_DMA_CHANNEL  LL_DMA_CHANNEL_2
#define ADIOS_ADC2_DMA_IRQn     DMA2_Stream1_IRQn
#define ADIOS_ADC2_DMA_IRQ_FUNC void DMA2_Stream1_IRQHandler(void)
#define ADIOS_ADC2_DMA_CLEAR()  do { LL_DMA_ClearFlag_TC1(DMA2); LL_DMA_ClearFlag_TE1(DMA2); LL_DMA_ClearFlag_HT1(DMA2); LL_DMA_ClearFlag_DME1(DMA2); LL_DMA_ClearFlag_FE1(DMA2); } while(0)
#endif
...
#if defined(ADIOS_USE_ADC0)
# define NUM_CHN_0 POPCNT16(ADIOS_ADC0_CHANNEL_MASK)
#else
# define NUM_CHN_0 0
#endif
#if defined(ADIOS_USE_ADC1)
# define NUM_CHN_1 POPCNT16(ADIOS_ADC1_CHANNEL_MASK)
#else
# define NUM_CHN_1 0
#endif
#if defined(ADIOS_USE_ADC2)
# define NUM_CHN_2 POPCNT16(ADIOS_ADC2_CHANNEL_MASK)
#else
# define NUM_CHN_2 0
#endif
...
#if defined(ADIOS_USE_ADC2) && NUM_CHN_2
#if !defined(GPIOF)
# error "ADIOS_USE_ADC2 (ADC3) needs PORTF for channels 4..9, 14 and 15. This package has no PORTF - only ADC3 channels 0..3 and 10..13 are bonded, and the map below cannot be built."
#endif
...
static void ADIOS_ADC_ScanComplete(u8 port)
{
  ...
  if( ++oversampling_ctr[port] < ADIOS_ADC_OVERSAMPLING_RATE )
  ...
  for(i=0; i<inst->num_chn; ++i) {
    ...
    u16 deadband = adc_channel_idle_ctr[slot] ? adc_deadband : ADIOS_ADC_DEADBAND_IDLE;
#else
...
#if ADIOS_ADC_DEADBAND_IDLE
      adc_channel_idle_ctr[slot] = ADIOS_ADC_IDLE_CTR;
#endif
    } else {
#if ADIOS_ADC_DEADBAND_IDLE
...
static u8 ADIOS_ADC_InstInit(u8 port, ADC_TypeDef *adc, u16 chn_mask, u8 num_chn,
                              ...
                              u32 dma_stream, u32 dma_channel, IRQn_Type dma_irqn)
{
  ...
  for(c=0; c<NUM_CHANNELS_MAX; ++c) {
    if( chn_mask & (1 << c) ) {
      ...
      LL_ADC_SetChannelSamplingTime(adc, ll_chn, ADIOS_ADC_SAMPLINGTIME);
      ++rank;
    }
  }
  ...
  ADIOS_IRQ_Install(dma_irqn, ADIOS_IRQ_ADC_DMA_PRIORITY);
...
static void ADIOS_ADC_InstStart(u8 port)
{
  adc_inst_t *inst = &adc_inst[port];
...
s32 ADIOS_ADC_Init(u32 mode)
{
  ...
  slot = ADIOS_ADC_InstInit(0, ADC1, ADIOS_ADC0_CHANNEL_MASK, NUM_CHN_0,
                             slot, adc_raw_0, pin_map_12,
                             ADIOS_ADC0_DMA_STREAM, ADIOS_ADC0_DMA_CHANNEL,
                             ADIOS_ADC0_DMA_IRQn);
#endif
#if NUM_CHN_1
  LL_APB2_GRP1_EnableClock(LL_APB2_GRP1_PERIPH_ADC2);
  slot = ADIOS_ADC_InstInit(1, ADC2, ADIOS_ADC1_CHANNEL_MASK, NUM_CHN_1,
                             slot, adc_raw_1, pin_map_12,
                             ADIOS_ADC1_DMA_STREAM, ADIOS_ADC1_DMA_CHANNEL,
                             ADIOS_ADC1_DMA_IRQn);
#endif
#if NUM_CHN_2
  LL_APB2_GRP1_EnableClock(LL_APB2_GRP1_PERIPH_ADC3);
  slot = ADIOS_ADC_InstInit(2, ADC3, ADIOS_ADC2_CHANNEL_MASK, NUM_CHN_2,
                             slot, adc_raw_2, pin_map_3,
                             ADIOS_ADC2_DMA_STREAM, ADIOS_ADC2_DMA_CHANNEL,
                             ADIOS_ADC2_DMA_IRQn);
#endif
...
//! numbering - the same numbers used in ADIOS_ADCn_CHANNEL_MASK.
//! \param[in] port ADIOS_ADC_PORT_ADC0/1/2
...
/////////////////////////////////////////////////////////////////////////////
#if NUM_CHN_0
ADIOS_ADC0_DMA_IRQ_FUNC
{
  ADIOS_ADC0_DMA_CLEAR();
  ADIOS_ADC_ScanComplete(0);
#if ADIOS_ADC_OVERSAMPLING_RATE >= 2
  if( oversampling_ctr[0] )
    ADIOS_ADC_InstStart(0); // more samples needed for this set
#endif
}
#endif

#if NUM_CHN_1
ADIOS_ADC1_DMA_IRQ_FUNC
{
  ADIOS_ADC1_DMA_CLEAR();
  ADIOS_ADC_ScanComplete(1);
#if ADIOS_ADC_OVERSAMPLING_RATE >= 2
  if( oversampling_ctr[1] )
    ADIOS_ADC_InstStart(1);
#endif
}
#endif

#if NUM_CHN_2
ADIOS_ADC2_DMA_IRQ_FUNC
{
  ADIOS_ADC2_DMA_CLEAR();
  ADIOS_ADC_ScanComplete(2);
#if ADIOS_ADC_OVERSAMPLING_RATE >= 2
  if( oversampling_ctr[2] )
    ADIOS_ADC_InstStart(2);
#endif
}
#endif
