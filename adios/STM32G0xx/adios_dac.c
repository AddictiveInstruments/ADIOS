//! \defgroup ADIOS_DAC
//!
//! DAC driver for ADIOS - STM32G0xx
//!
//!
...
#if !defined(DAC1)
# error "ADIOS_USE_DAC requested, but this STM32G0 has no DAC. It exists on G051/G061/G071/G081/G0B1/G0C1 only - not on G030, G031, G041, G050, G070 or G0B0."
#else
...
# error "ADIOS_DAC_CHANNEL_MASK has a bit above 1. This DAC has two channels: bit 0 is ADIOS_DAC_CHANNEL0 (PA4), bit 1 is ADIOS_DAC_CHANNEL1 (PA5)."
#endif
...
#ifndef ADIOS_DAC_OUTPUT_CONNECTION
#define ADIOS_DAC_OUTPUT_CONNECTION LL_DAC_OUTPUT_CONNECT_GPIO
#endif
...
#ifndef ADIOS_DAC_OUTPUT_MODE
#define ADIOS_DAC_OUTPUT_MODE LL_DAC_OUTPUT_MODE_NORMAL
#endif
...
//! that channel was not enabled by ADIOS_DAC_CHANNEL_MASK
...
s32 ADIOS_DAC_Init(u32 mode)
{
  ...
  for(c=0; c<2; ++c) {
    ...
    LL_DAC_SetOutputConnection(DAC1, chn_ll[c], ADIOS_DAC_OUTPUT_CONNECTION);
    LL_DAC_SetOutputMode(DAC1, chn_ll[c], ADIOS_DAC_OUTPUT_MODE);
