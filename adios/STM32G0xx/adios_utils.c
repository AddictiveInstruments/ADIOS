...
// timer used for ADIOS_DELAY functions (TIM1..TIM7)
#ifndef ADIOS_DELAY_TIMER
#define ADIOS_DELAY_TIMER  TIM14
#endif

#ifndef ADIOS_DELAY_TIMER_RCC
#define ADIOS_DELAY_TIMER_RCC LL_APB2_GRP1_PERIPH_TIM14
#endif
...
//!
//! Currently TIM14 is allocated by ADIOS_DELAY functions - if this clashes
...
s32 ADIOS_DELAY_Init(u32 mode)
{
  ...
  // enable timer clock
  LL_APB2_GRP1_EnableClock(ADIOS_DELAY_TIMER_RCC);
...
// ADIOS_DELAY (TIM14) or ADIOS_STOPWATCH (TIM17). This whole module was
...
// moment a project defined ADIOS_USE_TIMER, regardless of tier - nobody
...
// timers clocked at CPU clock
#define TIMER_TIM_PERIPHERAL_FRQ (ADIOS_SYS_CPU_FREQUENCY)
...
/////////////////////////////////////////////////////////////////////////////
#ifndef ADIOS_DONT_ALLOCATE_TIM1_IRQn
TIMER0_IRQ_HANDLER
{
...
#ifndef ADIOS_DONT_ALLOCATE_TIM16_IRQn
TIMER2_IRQ_HANDLER
{
...
// ADIOS_DELAY (TIM14) or ADIOS_TIMER's default table (TIM2/TIM3/TIM5,
// itself not universal either - TIM1/TIM16 left free for the application).
// Override all three together in your project's adios_config.h if TIM17
...
// single APB, left undivided by adios_sys.c, so a timer here runs at HCLK
