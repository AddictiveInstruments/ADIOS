 ...
 *
 * A 512-byte block device with the same face as ADIOS_SDCARD, so the file
 ...
 * interrupt: they drive ADIOS_USB_Handler() themselves while they wait. They
...
#ifndef ADIOS_USB_MSC_TIMEOUT_MS
# define ADIOS_USB_MSC_TIMEOUT_MS  1000
#endif
...
// time - see ADIOS_USB_MSC_SectorRead() - and this decides which: the one
...
// Watching for a card appearing or leaving - see ADIOS_USB_MSC_Periodic_mS().
...
//! \return < 0 on errors
/////////////////////////////////////////////////////////////////////////////
s32 ADIOS_USB_MSC_Init(u32 mode)
{
  if( mode != 0 )
    return -1;
...
/////////////////////////////////////////////////////////////////////////////
s32 ADIOS_USB_MSC_CheckAvailable(void)
{
...
//! \return < 0 on errors
/////////////////////////////////////////////////////////////////////////////
s32 ADIOS_USB_MSC_ReadyCallback_Init(void (*callback)(u8 ready))
{
...
//! \return < 0 on errors
/////////////////////////////////////////////////////////////////////////////
s32 ADIOS_USB_MSC_ChangeCallback_Init(void (*callback)(u8 dev, u8 connected))
{
...
/////////////////////////////////////////////////////////////////////////////
s32 ADIOS_USB_MSC_ConnectedNumGet(void)
{
  return dev_count;
}
...
/////////////////////////////////////////////////////////////////////////////
s32 ADIOS_USB_MSC_ConnectedGet(u8 n, adios_usb_msc_dev_info_t *info)
{
...
/////////////////////////////////////////////////////////////////////////////
s32 ADIOS_USB_MSC_SizeGet(u32 *num_sectors, u16 *sector_size)
{
  if( !ADIOS_USB_MSC_CheckAvailable() )
    return -1;
...
static s32 xfer_wait(void)
{
  ...
  while( !xfer_done ) {
    if( waited_ms >= ADIOS_USB_MSC_TIMEOUT_MS ) {
...
/////////////////////////////////////////////////////////////////////////////
s32 ADIOS_USB_MSC_SectorRead(u32 sector, u8 *buffer)
{
  u32 waited_ms = 0;
...
//! \return 0 on success, -1 no medium, -2 busy, -3 timeout, -4 refused
/////////////////////////////////////////////////////////////////////////////
s32 ADIOS_USB_MSC_SectorWrite(u32 sector, u8 *buffer)
{
  u32 waited_ms = 0;
...
#ifndef ADIOS_USB_MSC_PROBE_INTERVAL_MS
# define ADIOS_USB_MSC_PROBE_INTERVAL_MS 1000
#endif

// How long to wait for an answer before writing the question off.
#ifndef ADIOS_USB_MSC_PROBE_TIMEOUT_MS
# define ADIOS_USB_MSC_PROBE_TIMEOUT_MS 2000
#endif
...
//! \return < 0 on errors
/////////////////////////////////////////////////////////////////////////////
s32 ADIOS_USB_MSC_Periodic_mS(void)
{
  u8 count;
  ...
  {
    u8 ready = ADIOS_USB_MSC_CheckAvailable() ? 1 : 0;
  ...
  if( probe_busy ) {
    if( ++probe_waited < ADIOS_USB_MSC_PROBE_TIMEOUT_MS )
      return 0;
    probe_busy = 0;
  }
  probe_waited = 0;
  ...
  probe_countdown = ADIOS_USB_MSC_PROBE_INTERVAL_MS;
