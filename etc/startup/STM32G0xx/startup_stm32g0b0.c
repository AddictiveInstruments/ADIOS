//$Id: startup_stm32g0b0.c $
/**
 ******************************************************************************
 * @file      startup_stm32g0b0.c
 * @brief     G0B0xx vector table and reset handler for the GCC toolchain.
...
void WEAK TIM6_IRQHandler                (void);  /* TIM6 */
...
void WEAK USART3_4_5_6_IRQHandler        (void);  /* USART3, USART4, USART5, USART6 */
...
void (* const g_pfnVectors[])(void) =
{
	...
	USART3_4_5_6_IRQHandler           ,/* USART3, USART4, USART5, USART6 */
};
...
#pragma weak USART3_4_5_6_IRQHandler        = Default_Handler
