//$Id: startup_stm32g041.c $
/**
 ******************************************************************************
 * @file      startup_stm32g041.c
 * @brief     G041xx vector table and reset handler for the GCC toolchain.
...
void WEAK DMA1_Ch4_5_DMAMUX1_OVR_IRQHandler (void);  /* DMA1 Channel 4 to Channel 5, DMAMUX1 overrun */
...
void WEAK LPTIM2_IRQHandler              (void);  /* LPTIM2 */
