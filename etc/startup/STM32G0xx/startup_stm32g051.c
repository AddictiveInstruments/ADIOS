//$Id: startup_stm32g051.c $
/**
 ******************************************************************************
 * @file      startup_stm32g051.c
 * @brief     G051xx vector table and reset handler for the GCC toolchain.
...
void WEAK TIM6_DAC_LPTIM1_IRQHandler     (void);  /* TIM6, DAC & LPTIM1 */
void WEAK TIM7_LPTIM2_IRQHandler         (void);  /* TIM7 & LPTIM2 */
...
void WEAK LPUART1_IRQHandler             (void);  /* LPUART1 */
...
void (* const g_pfnVectors[])(void) =
{
	...
	TIM6_DAC_LPTIM1_IRQHandler        ,/* TIM6, DAC & LPTIM1 */
	TIM7_LPTIM2_IRQHandler            ,/* TIM7 & LPTIM2 */
