//$Id: startup_stm32g070.c $
/**
 ******************************************************************************
 * @file      startup_stm32g070.c
 * @brief     STM32G070xx vector table and reset handler for the GCC toolchain.
...
void WEAK USART3_4_IRQHandler               (void);  /* USART3_4                     */
