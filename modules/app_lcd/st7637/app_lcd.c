...
#define APP_LCD_D_PINS         (LL_GPIO_PIN_0|LL_GPIO_PIN_1|LL_GPIO_PIN_2|LL_GPIO_PIN_3|LL_GPIO_PIN_4|LL_GPIO_PIN_5|LL_GPIO_PIN_6|LL_GPIO_PIN_7)
#define APP_LCD_D_PORT         GPIOC

#define APP_LCD_BL_PORT        GPIOB
#define APP_LCD_BL_PIN         LL_GPIO_PIN_7

#define APP_LCD_RS_PORT        GPIOC
#define APP_LCD_RS_PIN         LL_GPIO_PIN_8

#define APP_LCD_RD_PORT        GPIOC
#define APP_LCD_RD_PIN         LL_GPIO_PIN_9

#define APP_LCD_WR_PORT        GPIOC
#define APP_LCD_WR_PIN         LL_GPIO_PIN_10

#define APP_LCD_CS_PORT        GPIOC
#define APP_LCD_CS_PIN         LL_GPIO_PIN_11

#define APP_LCD_RST_PORT       GPIOC
#define APP_LCD_RST_PIN        LL_GPIO_PIN_12
