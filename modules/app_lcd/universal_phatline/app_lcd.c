...
inline static s32 APP_LCD_ExtPort_SerDataShift(u8 data, u8 lsb_first) {
  ...
  if( lsb_first ) {
    for(i=0; i<8; ++i, data >>= 1) {
      MIOS32_SYS_STM_PINSET(GPIOC, LL_GPIO_PIN_4, data & 1); // J5C.A8 = ser
      MIOS32_SYS_STM_PINSET_0(GPIOC, LL_GPIO_PIN_5); // J5C.A9 = 0 (Clk)
      MIOS32_SYS_STM_PINSET_0(GPIOC, LL_GPIO_PIN_5); // stretch
      MIOS32_SYS_STM_PINSET_0(GPIOC, LL_GPIO_PIN_5); // stretch
      MIOS32_SYS_STM_PINSET_1(GPIOC, LL_GPIO_PIN_5); // J5C.A9 = 1 (Clk)
      MIOS32_SYS_STM_PINSET_1(GPIOC, LL_GPIO_PIN_5); // stretch
    }
  } else {
    for(i=0; i<8; ++i, data <<= 1) {
      MIOS32_SYS_STM_PINSET(GPIOC, LL_GPIO_PIN_4, data & 0x80); // J5C.A8 = ser
      MIOS32_SYS_STM_PINSET_0(GPIOC, LL_GPIO_PIN_5); // J5C.A9 = 0 (Clk)
      MIOS32_SYS_STM_PINSET_0(GPIOC, LL_GPIO_PIN_5); // stretch
      MIOS32_SYS_STM_PINSET_0(GPIOC, LL_GPIO_PIN_5); // stretch
      MIOS32_SYS_STM_PINSET_1(GPIOC, LL_GPIO_PIN_5); // J5C.A9 = 1 (Clk)
  ...
  if( lsb_first ) {
    for(i=0; i<8; ++i, data >>= 1) {
      MIOS32_SYS_STM_PINSET(GPIOC, LL_GPIO_PIN_13, data & 1); // J10B.D8 = ser
      MIOS32_SYS_STM_PINSET_0(GPIOC, LL_GPIO_PIN_14); // J10B.D9 = 0 (Clk)
      MIOS32_SYS_STM_PINSET_0(GPIOC, LL_GPIO_PIN_14); // stretch
      MIOS32_SYS_STM_PINSET_0(GPIOC, LL_GPIO_PIN_14); // stretch
      MIOS32_SYS_STM_PINSET_0(GPIOC, LL_GPIO_PIN_14); // stretch
      MIOS32_SYS_STM_PINSET_0(GPIOC, LL_GPIO_PIN_14); // stretch
      MIOS32_SYS_STM_PINSET_1(GPIOC, LL_GPIO_PIN_14); // J10B.D9 = 1 (Clk)
      MIOS32_SYS_STM_PINSET_1(GPIOC, LL_GPIO_PIN_14); // stretch
      MIOS32_SYS_STM_PINSET_1(GPIOC, LL_GPIO_PIN_14); // stretch
    }
  } else {
    for(i=0; i<8; ++i, data <<= 1) {
      MIOS32_SYS_STM_PINSET(GPIOC, LL_GPIO_PIN_13, data & 0x80); // J10B.D8 = ser
      MIOS32_SYS_STM_PINSET_0(GPIOC, LL_GPIO_PIN_14); // J10B.D9 = 0 (Clk)
      MIOS32_SYS_STM_PINSET_0(GPIOC, LL_GPIO_PIN_14); // stretch
      MIOS32_SYS_STM_PINSET_0(GPIOC, LL_GPIO_PIN_14); // stretch
      MIOS32_SYS_STM_PINSET_0(GPIOC, LL_GPIO_PIN_14); // stretch
