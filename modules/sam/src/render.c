...
void RenderSample(unsigned char *mem66, unsigned char consonantFlag, unsigned char frm_idx)
{     
  // frm_idx == current frame's index
...
//#if ((SAM_VERBOSE_LEVEL<=2) && (SAM_VERBOSE_LEVEL!=0))
  PrintOutput(t, sampledConsonantFlag, frequency1, frequency2, frequency3, amplitude1, amplitude2, amplitude3, pitches);
//#endif
//#ifdef SAM_REALTIME
//frm=0;
//  while(frm<t){
//    frm = ProcessFrame(frm, t);
//  }
//#else
