...
//! SPI-MIDI link.
//!
//! Split out of mios32/common/mios32_spi_midi.c on 2026-08-14. Everything
//! here used to live inside the transport behind MIOS32_SPI_MIDI_USE_M16
...
# error "The M16 is reached over SPI-MIDI: add #define MIOS32_USE_SPI_MIDI to your mios32_config.h."
#endif
...
//!
//! Was MIOS32_SPI_MIDI_RS_OptimisationSet/Get in the transport, whose entire
...
//! \param[in] spim_port the port (0..MIOS32_SPI_MIDI_NUM_PORTS-1)
//! \param[in] enable 0 to disable, 1 to enable
//! \return < 0 on errors
/////////////////////////////////////////////////////////////////////////////
s32 MIOS32_SPIM_M16_RS_OptimisationSet(u8 spim_port, u8 enable)
{
...
/////////////////////////////////////////////////////////////////////////////
s32 MIOS32_SPIM_M16_RS_OptimisationGet(u8 spim_port)
{
  if( spim_port >= MIOS32_SPI_MIDI_NUM_PORTS )
    return -1; // port not available
...
/////////////////////////////////////////////////////////////////////////////
//! Initializes the M16. Call once, AFTER MIOS32_SPI_MIDI_Init().
//!
...
//! \return < 0 on errors
/////////////////////////////////////////////////////////////////////////////
s32 MIOS32_SPIM_M16_Init(u32 mode)
{
  if( mode != 0 )
  ...
  MIOS32_SPI_MIDI_RawWordCallback_Init(M16_RawWordCallback);
