...
// PIXI
#define     PIXI_SPI_PERIPH              0
#if !defined(PIXI_NUM)
#define PIXI_NUM 1
#endif


#define MAX_NUM PIXI_NUM
// MAX11300
#define     MAX_SPI_PERIPH              PIXI_SPI_PERIPH
// Periph
#define     MAX_SPI_PERIPH_J16           0
#define     MAX_SPI_PERIPH_J89           1
#define     MAX_SPI_PERIPH_J19           2
#define     MAX_GPIO_PERIPH_J10          3
#define     MAX_SPI_PIN_RC1              0
#define     MAX_SPI_PIN_RC2              1
#define     MAX_GPIO_PIN_D0              0
#define     MAX_GPIO_PIN_D1              1
#define     MAX_GPIO_PIN_D2              2
#define     MAX_GPIO_PIN_D3              3
#define     MAX_GPIO_PIN_D4              4
#define     MAX_GPIO_PIN_D5              5
#define     MAX_GPIO_PIN_D6              6
#define     MAX_GPIO_PIN_D7              7
#define     MAX_MUXED_RC                 -1
#define     MAX_SPI_PINS_OD              1
#define     MAX_SPI_PINS_PP              0
