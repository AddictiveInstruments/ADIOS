 ...
 * HOW TO USE IT
 *
 * 1) Ask for the transport in your adios_config.h:
 *
 ...
 *
 *      #define ADIOS_USB_MIDI_NUM_PORTS 4
 *
 * 3) Give the product its own identity - see adios_usb.h. The defaults here
...
// of the silicon, so the family makefile states it - adios/<FAMILY>/
// adios_family.mk - and never a header in the common tree.
#ifndef CFG_TUSB_MCU
# error "CFG_TUSB_MCU is not defined. It is set by adios/<FAMILY>/adios_family.mk; a family that reaches this point has no USB support declared yet."
#endif
...
// SWD (adios_usb_dbg_printf in adios_usb.c), which is how the hub problem
...
#endif
#define CFG_TUSB_DEBUG_PRINTF       adios_usb_dbg_printf
...
#endif
#if ADIOS_USB_MIDI_NUM_PORTS < 1 || ADIOS_USB_MIDI_NUM_PORTS > 16
# error "ADIOS_USB_MIDI_NUM_PORTS must be 1..16 - the USB MIDI 1.0 class allows no more than 16 cables on one interface."
#endif
...
#ifndef ADIOS_USB_MIDI_RX_BUFSIZE
# define ADIOS_USB_MIDI_RX_BUFSIZE 256
#endif
#ifndef ADIOS_USB_MIDI_TX_BUFSIZE
# define ADIOS_USB_MIDI_TX_BUFSIZE 512
#endif
#define CFG_TUD_MIDI_RX_BUFSIZE     ADIOS_USB_MIDI_RX_BUFSIZE
#define CFG_TUD_MIDI_TX_BUFSIZE     ADIOS_USB_MIDI_TX_BUFSIZE
...
//   #define ADIOS_USB_VBUS_SENSING 1
#ifndef ADIOS_USB_VBUS_SENSING
# define ADIOS_USB_VBUS_SENSING    0
#endif
#define CFG_TUD_VBUS_DETECT_HW      ADIOS_USB_VBUS_SENSING
...
# ifndef ADIOS_USB_HOST_HUB
#  define ADIOS_USB_HOST_HUB       2
# endif
# define CFG_TUH_HUB                ADIOS_USB_HOST_HUB

// How many devices may be attached at once, hubs included. Each costs RAM,
// so this is a project decision.
# ifndef ADIOS_USB_HOST_MAX_DEVICES
#  define ADIOS_USB_HOST_MAX_DEVICES 4
# endif
# define CFG_TUH_DEVICE_MAX         (ADIOS_USB_HOST_MAX_DEVICES + CFG_TUH_HUB)
