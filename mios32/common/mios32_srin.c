...
/////////////////////////////////////////////////////////////////////////////
s32 MIOS32_SRIN_PinGet(u32 pin)
{
...
//! it should call
//! \code
//!   changed = MIOS32_SRIN_SRChangedGetAndClear(0, 0xff)
//! \endcode
...
//! \code
//!   changed = MIOS32_SRIN_SRChangedGetAndClear(0, 0xc0)
//! \endcode
...
/////////////////////////////////////////////////////////////////////////////
u8 MIOS32_SRIN_SRChangedGetAndClear(u32 sr, u8 mask)
{
  u8 num_sr = MIOS32_SRIO_ScanNumGet();
  u8 changed;
...
//! \return < 0 on errors
/////////////////////////////////////////////////////////////////////////////
s32 MIOS32_SRIN_Handler(void *_callback)
{
  s32 sr;
  s32 sr_pin;
  u8 changed;
  ...
  for(sr=0; sr<num_sr; ++sr) {
    ...
    changed = MIOS32_SRIN_SRChangedGetAndClear(sr, 0xff);
