...
// To use it, declare MIOS32_USE_SRIO in your project's
// mios32_config.h.
...
s32 MIOS32_SRIO_ScanStart(void *_notify_hook)
{
  ...
  MIOS32_SPI_CS_PinSet(MIOS32_SRIO_SPI, 0);
  // delay disabled - the delay caused by MIOS32_SPI_CS_PinSet function calls is sufficient
