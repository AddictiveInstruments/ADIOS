...
// Opt-in since 2026-08-13: declare MIOS32_USE_SROUT in your project's
// mios32_config.h. It used to arrive on its own and had to be refused with
// MIOS32_DONT_USE_SROUT, which every project in the tree did.
#if defined(MIOS32_USE_SROUT)
...
# error "MIOS32_USE_SROUT needs the shift register engine: add #define MIOS32_USE_SRIO to your mios32_config.h."
#endif
...
const u8 mios32_srout_reverse_tab[256] = {
...
/////////////////////////////////////////////////////////////////////////////
s32 MIOS32_SROUT_Init(u32 mode)
{
  int i;
...
/////////////////////////////////////////////////////////////////////////////
s32 MIOS32_SROUT_PinGet(u32 pin)
{
...
//! \return -1 if pin not available
/////////////////////////////////////////////////////////////////////////////
s32 MIOS32_SROUT_PinSet(u32 pin, u32 value)
{
  u8 num_sr = MIOS32_SRIO_ScanNumGet();
...
//! \return -1 if pin not available
/////////////////////////////////////////////////////////////////////////////
s32 MIOS32_SROUT_PagePinGet(u8 page, u32 pin)
{
...
//! \return -1 if pin not available
/////////////////////////////////////////////////////////////////////////////
s32 MIOS32_SROUT_PagePinSet(u8 page, u32 pin, u32 value)
{
  if( page >= MIOS32_SRIO_NUM_DOUT_PAGES )
    return -2; // invalid page
...
s32 MIOS32_SROUT_SRGet(u32 sr)
{
  ...
  return mios32_srout_reverse_tab[mios32_srio_dout[0][num_sr - sr - 1]];
}
...
//! \return -1 if shift register not available
/////////////////////////////////////////////////////////////////////////////
s32 MIOS32_SROUT_SRSet(u32 sr, u8 value)
{
  u8 num_sr = MIOS32_SRIO_ScanNumGet();
  ...
  u8 mapped_value = mios32_srout_reverse_tab[value];
...
//! \return -1 if shift register not available
/////////////////////////////////////////////////////////////////////////////
s32 MIOS32_SROUT_PageSRGet(u8 page, u32 sr)
{
  if( page >= MIOS32_SRIO_NUM_DOUT_PAGES )
    return -2; // invalid page
  ...
  return mios32_srout_reverse_tab[mios32_srio_dout[page][num_sr - sr - 1]];
}
...
//! \return -1 if shift register not available
/////////////////////////////////////////////////////////////////////////////
s32 MIOS32_SROUT_PageSRSet(u8 page, u32 sr, u8 value)
{
  if( page >= MIOS32_SRIO_NUM_DOUT_PAGES )
    return -2; // invalid page
