...
// The defaults themselves live in mios32_usb.h, where every layer can read
...
#ifndef MIOS32_USB_P0_ID_PORT
# define MIOS32_USB_P0_ID_PORT      GPIOA
#endif
#ifndef MIOS32_USB_P0_ID_PIN
# define MIOS32_USB_P0_ID_PIN       LL_GPIO_PIN_10
#endif
#ifndef MIOS32_USB_P1_ID_PORT
# define MIOS32_USB_P1_ID_PORT      GPIOB
#endif
#ifndef MIOS32_USB_P1_ID_PIN
# define MIOS32_USB_P1_ID_PIN       LL_GPIO_PIN_12
#endif
...
#endif
#ifndef MIOS32_USB_P0_VBUS_ACTIVE_HIGH
# define MIOS32_USB_P0_VBUS_ACTIVE_HIGH 0
#endif
...
#ifndef MIOS32_USB_P0_OC_ACTIVE_HIGH
# define MIOS32_USB_P0_OC_ACTIVE_HIGH 0
#endif
#ifndef MIOS32_USB_P1_OC_ACTIVE_HIGH
# define MIOS32_USB_P1_OC_ACTIVE_HIGH 0
#endif
...
s32 MIOS32_USB_LL_Init(u8 port, mios32_usb_role_t role)
{
  ...
  if( port == 0 ) {
    ...
    vbus_drive(MIOS32_USB_P0_VBUS_PORT, MIOS32_USB_P0_VBUS_PIN,
               MIOS32_USB_P0_VBUS_ACTIVE_HIGH, role == MIOS32_USB_ROLE_HOST);
#endif
#ifdef MIOS32_USB_P0_OC_PIN
    sense_claim(MIOS32_USB_P0_OC_PORT, MIOS32_USB_P0_OC_PIN,
                MIOS32_USB_P0_OC_ACTIVE_HIGH);
#endif
...
#if MIOS32_USB_NUM_PORTS > 1 && defined(MIOS32_USB_P1_VBUS_PIN)
    vbus_drive(MIOS32_USB_P1_VBUS_PORT, MIOS32_USB_P1_VBUS_PIN,
               MIOS32_USB_P1_VBUS_ACTIVE_HIGH, role == MIOS32_USB_ROLE_HOST);
#endif
#if MIOS32_USB_NUM_PORTS > 1 && defined(MIOS32_USB_P1_OC_PIN)
    sense_claim(MIOS32_USB_P1_OC_PORT, MIOS32_USB_P1_OC_PIN,
                MIOS32_USB_P1_OC_ACTIVE_HIGH);
#endif
...
#if MIOS32_USB_P0_ROLE_SOURCE == MIOS32_USB_ROLE_SRC_ID || MIOS32_USB_P1_ROLE_SOURCE == MIOS32_USB_ROLE_SRC_ID
static u8 id_claimed;

static mios32_usb_role_t id_read(u8 port, GPIO_TypeDef *gpio_port, u32 pin)
{
  ...
  return LL_GPIO_IsInputPinSet(gpio_port, pin) ? MIOS32_USB_ROLE_DEVICE
                                               : MIOS32_USB_ROLE_HOST;
}
#endif
...
//! \param[in] port 0 for OTG_FS, 1 for OTG_HS
//! \return the role read, or MIOS32_USB_ROLE_NONE when this port detects
//!         none - which is not a failure, it is a fixed port saying "the
//!         project decides, not me"
/////////////////////////////////////////////////////////////////////////////
mios32_usb_role_t MIOS32_USB_LL_RoleDetect(u8 port)
{
  switch( port ) {
#if MIOS32_USB_P0_ROLE_SOURCE == MIOS32_USB_ROLE_SRC_ID
  case 0: return id_read(0, MIOS32_USB_P0_ID_PORT, MIOS32_USB_P0_ID_PIN);
#endif
#if MIOS32_USB_P1_ROLE_SOURCE == MIOS32_USB_ROLE_SRC_ID
  case 1: return id_read(1, MIOS32_USB_P1_ID_PORT, MIOS32_USB_P1_ID_PIN);
#endif
  default: break;
  }
...
/////////////////////////////////////////////////////////////////////////////
s32 MIOS32_USB_LL_OverCurrent(u8 port)
{
  switch( port ) {
#ifdef MIOS32_USB_P0_OC_PIN
  case 0: return LL_GPIO_IsInputPinSet(MIOS32_USB_P0_OC_PORT, MIOS32_USB_P0_OC_PIN)
                 == MIOS32_USB_P0_OC_ACTIVE_HIGH;
#endif
#ifdef MIOS32_USB_P1_OC_PIN
  case 1: return LL_GPIO_IsInputPinSet(MIOS32_USB_P1_OC_PORT, MIOS32_USB_P1_OC_PIN)
                 == MIOS32_USB_P1_OC_ACTIVE_HIGH;
#endif
  default: break;
  }
