...
//!     uses mios32/common/mios32_i2c_v2.inc, shared with the G0 driver.
...
//!
//! Port numbering follows the peripheral: MIOS32_I2C0 is I2C1, MIOS32_I2C1
//! is I2C2, MIOS32_I2C2 is I2C3. FMPI2C1 keeps ST's own name and sits at
//! port index MIOS32_I2C_PORT_FMPI2C0 (3) - it is not "I2C4", and on the
...
#if defined(MIOS32_USE_I2C2) && !defined(I2C3)
#undef MIOS32_USE_I2C2
#endif

// FMPI2C1 exists on F410/F412/F413/F423/F446 only
#if defined(MIOS32_USE_FMPI2C0) && !defined(FMPI2C1)
#undef MIOS32_USE_FMPI2C0
#endif
...
//
// All of it is overridable from a project's mios32_config.h, including what
...
#endif
#ifndef MIOS32_FMPI2C0_BUS_FREQUENCY
#define MIOS32_FMPI2C0_BUS_FREQUENCY 400000
#endif

//! Fast mode duty cycle, v1 only: 2 gives t_LOW/t_HIGH = 2, 16/9 buys a bit
//! more margin on the rise time at 400 kHz.
#ifndef MIOS32_I2C_DUTYCYCLE
#define MIOS32_I2C_DUTYCYCLE LL_I2C_DUTYCYCLE_2
#endif
...
#ifndef MIOS32_FMPI2C_ANALOG_FILTER
#define MIOS32_FMPI2C_ANALOG_FILTER LL_FMPI2C_ANALOGFILTER_ENABLE
#endif
#ifndef MIOS32_FMPI2C_DIGITAL_FILTER
#define MIOS32_FMPI2C_DIGITAL_FILTER 0
#endif

//! 1 = no interrupts on this port, MIOS32_I2C_TransferWait() drives it.
...
#endif
#ifndef MIOS32_FMPI2C0_POLLED
#define MIOS32_FMPI2C0_POLLED 0
#endif
...
#define MIOS32_I2C0_SCL_AF     LL_GPIO_AF_4
#endif
...
#define MIOS32_I2C0_SDA_AF     LL_GPIO_AF_4
#endif
#ifndef MIOS32_I2C0_IRQ_EV_CHANNEL
#define MIOS32_I2C0_IRQ_EV_CHANNEL I2C1_EV_IRQn
#endif
#ifndef MIOS32_I2C0_IRQ_ER_CHANNEL
#define MIOS32_I2C0_IRQ_ER_CHANNEL I2C1_ER_IRQn
#endif
#ifndef MIOS32_I2C0_IRQHANDLER_EV_FUNC
#define MIOS32_I2C0_IRQHANDLER_EV_FUNC void I2C1_EV_IRQHandler(void)
#endif
#ifndef MIOS32_I2C0_IRQHANDLER_ER_FUNC
#define MIOS32_I2C0_IRQHANDLER_ER_FUNC void I2C1_ER_IRQHandler(void)
#endif
...
#define MIOS32_I2C1_SCL_AF     LL_GPIO_AF_4
#endif
...
#define MIOS32_I2C1_SDA_AF     LL_GPIO_AF_4
#endif
#ifndef MIOS32_I2C1_IRQ_EV_CHANNEL
#define MIOS32_I2C1_IRQ_EV_CHANNEL I2C2_EV_IRQn
#endif
#ifndef MIOS32_I2C1_IRQ_ER_CHANNEL
#define MIOS32_I2C1_IRQ_ER_CHANNEL I2C2_ER_IRQn
#endif
#ifndef MIOS32_I2C1_IRQHANDLER_EV_FUNC
#define MIOS32_I2C1_IRQHANDLER_EV_FUNC void I2C2_EV_IRQHandler(void)
#endif
#ifndef MIOS32_I2C1_IRQHANDLER_ER_FUNC
#define MIOS32_I2C1_IRQHANDLER_ER_FUNC void I2C2_ER_IRQHandler(void)
#endif
...
#define MIOS32_I2C2_SCL_PORT   GPIOA
#endif
#ifndef MIOS32_I2C2_SCL_PIN
#define MIOS32_I2C2_SCL_PIN    LL_GPIO_PIN_8
#endif
#ifndef MIOS32_I2C2_SCL_AF
#define MIOS32_I2C2_SCL_AF     LL_GPIO_AF_4
#endif
#ifndef MIOS32_I2C2_SDA_PORT
#define MIOS32_I2C2_SDA_PORT   GPIOC
#endif
#ifndef MIOS32_I2C2_SDA_PIN
#define MIOS32_I2C2_SDA_PIN    LL_GPIO_PIN_9
#endif
#ifndef MIOS32_I2C2_SDA_AF
#define MIOS32_I2C2_SDA_AF     LL_GPIO_AF_4
#endif
#ifndef MIOS32_I2C2_IRQ_EV_CHANNEL
#define MIOS32_I2C2_IRQ_EV_CHANNEL I2C3_EV_IRQn
#endif
#ifndef MIOS32_I2C2_IRQ_ER_CHANNEL
#define MIOS32_I2C2_IRQ_ER_CHANNEL I2C3_ER_IRQn
#endif
#ifndef MIOS32_I2C2_IRQHANDLER_EV_FUNC
#define MIOS32_I2C2_IRQHANDLER_EV_FUNC void I2C3_EV_IRQHandler(void)
#endif
#ifndef MIOS32_I2C2_IRQHANDLER_ER_FUNC
#define MIOS32_I2C2_IRQHANDLER_ER_FUNC void I2C3_ER_IRQHandler(void)
#endif
#endif

// ---- port 3 = FMPI2C1 (v2), F410/F412/F413/F423/F446 only ------------------
#ifdef MIOS32_USE_FMPI2C0
#define MIOS32_FMPI2C0_PTR     FMPI2C1
#ifndef MIOS32_FMPI2C0_CLOCK
#define MIOS32_FMPI2C0_CLOCK   LL_APB1_GRP1_PERIPH_FMPI2C1
#endif
//! Kernel clock. Unlike v1, a v2 block does not run off PCLK unless told to;
//! HSI makes its timing independent of the clock tree.
#ifndef MIOS32_FMPI2C0_CLKSOURCE
#define MIOS32_FMPI2C0_CLKSOURCE LL_RCC_FMPI2C1_CLKSOURCE_PCLK1
#endif
#ifndef MIOS32_FMPI2C0_SCL_PORT
#define MIOS32_FMPI2C0_SCL_PORT GPIOC
#endif
#ifndef MIOS32_FMPI2C0_SCL_PIN
#define MIOS32_FMPI2C0_SCL_PIN  LL_GPIO_PIN_6
#endif
#ifndef MIOS32_FMPI2C0_SCL_AF
#define MIOS32_FMPI2C0_SCL_AF   LL_GPIO_AF_4
#endif
#ifndef MIOS32_FMPI2C0_SDA_PORT
#define MIOS32_FMPI2C0_SDA_PORT GPIOC
#endif
#ifndef MIOS32_FMPI2C0_SDA_PIN
#define MIOS32_FMPI2C0_SDA_PIN  LL_GPIO_PIN_7
#endif
#ifndef MIOS32_FMPI2C0_SDA_AF
#define MIOS32_FMPI2C0_SDA_AF   LL_GPIO_AF_4
#endif
#ifndef MIOS32_FMPI2C0_IRQ_EV_CHANNEL
#define MIOS32_FMPI2C0_IRQ_EV_CHANNEL FMPI2C1_EV_IRQn
#endif
#ifndef MIOS32_FMPI2C0_IRQ_ER_CHANNEL
#define MIOS32_FMPI2C0_IRQ_ER_CHANNEL FMPI2C1_ER_IRQn
#endif
#ifndef MIOS32_FMPI2C0_IRQHANDLER_EV_FUNC
#define MIOS32_FMPI2C0_IRQHANDLER_EV_FUNC void FMPI2C1_EV_IRQHandler(void)
#endif
#ifndef MIOS32_FMPI2C0_IRQHANDLER_ER_FUNC
#define MIOS32_FMPI2C0_IRQHANDLER_ER_FUNC void FMPI2C1_ER_IRQHandler(void)
#endif
#endif
...
static void MIOS32_I2C_V1_Finish(mios32_i2c_v1_rec_t *rec, s32 error)
{
...
static void MIOS32_I2C_V1_Step(mios32_i2c_v1_rec_t *rec)
{
  ...
  if( LL_I2C_IsActiveFlag_AF(base) ) {
    ...
    MIOS32_I2C_V1_Finish(rec, MIOS32_I2C_ERROR_SLAVE_NOT_CONNECTED);
    return;
  }

  if( LL_I2C_IsActiveFlag_ARLO(base) ) {
    LL_I2C_ClearFlag_ARLO(base);
    MIOS32_I2C_V1_Finish(rec, MIOS32_I2C_ERROR_ARBITRATION_LOST);
    return;
  }
  ...
  if( LL_I2C_IsActiveFlag_BERR(base) ) {
    ...
    LL_I2C_GenerateStopCondition(base);
    MIOS32_I2C_V1_Finish(rec, MIOS32_I2C_ERROR_BUS);
    return;
  }

  if( LL_I2C_IsActiveFlag_OVR(base) ) {
    LL_I2C_ClearFlag_OVR(base);
    MIOS32_I2C_V1_Finish(rec, MIOS32_I2C_ERROR_RX_BUFFER_OVERRUN);
    return;
  }
  ...
  case V1_START:
    if( LL_I2C_IsActiveFlag_SB(base) ) {
      ...
      if( rec->transfer_type == MIOS32_I2C_READ )
...
static s32 MIOS32_I2C_V1_TransferStart(mios32_i2c_v1_rec_t *rec,
                                       ...
                                       u8 address, u8 *buffer, u16 len)
{
  ...
  if( transfer == MIOS32_I2C_READ && len == 2 )
...
static s32 MIOS32_I2C_V1_TransferWait(mios32_i2c_v1_rec_t *rec)
{
  u32 timeout = MIOS32_I2C_TIMEOUT_VALUE;

  while( rec->busy && timeout-- ) {
    if( rec->polled )
      MIOS32_I2C_V1_Step(rec);
  ...
  if( rec->busy ) {
    ...
    MIOS32_I2C_V1_Finish(rec, MIOS32_I2C_ERROR_TIMEOUT);
...
static void MIOS32_I2C_V1_PortInit(mios32_i2c_v1_rec_t *rec, I2C_TypeDef *base,
                                   u32 bus_frequency, u8 polled)
{
  ...
  I2C_InitStruct.DutyCycle = MIOS32_I2C_DUTYCYCLE;
#if defined(I2C_FLTR_ANOFF) && defined(I2C_FLTR_DNF)
  I2C_InitStruct.AnalogFilter = MIOS32_I2C_ANALOG_FILTER;
  I2C_InitStruct.DigitalFilter = MIOS32_I2C_DIGITAL_FILTER;
#endif
...
static mios32_i2c_v1_rec_t i2c0_rec;
#endif
#ifdef MIOS32_USE_I2C1
static mios32_i2c_v1_rec_t i2c1_rec;
#endif
#ifdef MIOS32_USE_I2C2
static mios32_i2c_v1_rec_t i2c2_rec;
#endif
#ifdef MIOS32_USE_FMPI2C0
static mios32_i2c_v2_rec_t fmpi2c0_rec;
#endif

#define MIOS32_I2C_PORT_NUM 4

static mios32_i2c_v1_rec_t * const i2c_v1_rec[MIOS32_I2C_PORT_NUM] = {
#ifdef MIOS32_USE_I2C0
  &i2c0_rec,
#else
  NULL,
...
s32 MIOS32_I2C_Init(u32 mode)
{
  ...
  MIOS32_I2C_V1_PortInit(&i2c0_rec, MIOS32_I2C0_PTR, MIOS32_I2C0_BUS_FREQUENCY, MIOS32_I2C0_POLLED);
#if !MIOS32_I2C0_POLLED
  MIOS32_IRQ_Install(MIOS32_I2C0_IRQ_EV_CHANNEL, MIOS32_IRQ_I2C_EV_PRIORITY);
  MIOS32_IRQ_Install(MIOS32_I2C0_IRQ_ER_CHANNEL, MIOS32_IRQ_I2C_ER_PRIORITY);
#endif
#endif
  ...
  MIOS32_I2C_V1_PortInit(&i2c1_rec, MIOS32_I2C1_PTR, MIOS32_I2C1_BUS_FREQUENCY, MIOS32_I2C1_POLLED);
#if !MIOS32_I2C1_POLLED
  MIOS32_IRQ_Install(MIOS32_I2C1_IRQ_EV_CHANNEL, MIOS32_IRQ_I2C_EV_PRIORITY);
  MIOS32_IRQ_Install(MIOS32_I2C1_IRQ_ER_CHANNEL, MIOS32_IRQ_I2C_ER_PRIORITY);
#endif
#endif
  ...
  MIOS32_I2C_V1_PortInit(&i2c2_rec, MIOS32_I2C2_PTR, MIOS32_I2C2_BUS_FREQUENCY, MIOS32_I2C2_POLLED);
#if !MIOS32_I2C2_POLLED
  MIOS32_IRQ_Install(MIOS32_I2C2_IRQ_EV_CHANNEL, MIOS32_IRQ_I2C_EV_PRIORITY);
  MIOS32_IRQ_Install(MIOS32_I2C2_IRQ_ER_CHANNEL, MIOS32_IRQ_I2C_ER_PRIORITY);
#endif
#endif
...
#ifdef MIOS32_USE_FMPI2C0
  {
    ...
    LL_APB1_GRP1_EnableClock(MIOS32_FMPI2C0_CLOCK);
    LL_RCC_SetFMPI2CClockSource(MIOS32_FMPI2C0_CLKSOURCE);

    MIOS32_I2C_PinInit(MIOS32_FMPI2C0_SCL_PORT, MIOS32_FMPI2C0_SCL_PIN, MIOS32_FMPI2C0_SCL_AF);
    MIOS32_I2C_PinInit(MIOS32_FMPI2C0_SDA_PORT, MIOS32_FMPI2C0_SDA_PIN, MIOS32_FMPI2C0_SDA_AF);

#ifdef MIOS32_FMPI2C0_TIMINGR
    timing = MIOS32_FMPI2C0_TIMINGR;
#else
    timing = MIOS32_I2C_V2_TimingCalc(LL_RCC_GetFMPI2CClockFreq(LL_RCC_FMPI2C1_CLKSOURCE),
                                      MIOS32_FMPI2C0_BUS_FREQUENCY,
                                      MIOS32_FMPI2C_ANALOG_FILTER == LL_FMPI2C_ANALOGFILTER_ENABLE,
                                      MIOS32_FMPI2C_DIGITAL_FILTER);
#endif

    MIOS32_I2C_V2_PortInit(&fmpi2c0_rec, MIOS32_FMPI2C0_PTR, timing,
                           MIOS32_FMPI2C_ANALOG_FILTER, MIOS32_FMPI2C_DIGITAL_FILTER,
                           MIOS32_FMPI2C0_POLLED);

#if !MIOS32_FMPI2C0_POLLED
    MIOS32_IRQ_Install(MIOS32_FMPI2C0_IRQ_EV_CHANNEL, MIOS32_IRQ_I2C_EV_PRIORITY);
    MIOS32_IRQ_Install(MIOS32_FMPI2C0_IRQ_ER_CHANNEL, MIOS32_IRQ_I2C_ER_PRIORITY);
#endif
  }
#endif
...
//! same bus.
//! \param[in] i2c_port the port (0..2, or MIOS32_I2C_PORT_FMPI2C0)
...
#ifdef MIOS32_USE_FMPI2C0
  if( i2c_port == MIOS32_I2C_PORT_FMPI2C0 )
    semaphore = &fmpi2c0_rec.semaphore;
  else
#endif
  {
    if( i2c_port >= MIOS32_I2C_PORT_NUM || i2c_v1_rec[i2c_port] == NULL )
      return MIOS32_I2C_ERROR_INVALID_PORT;
...
#ifdef MIOS32_USE_FMPI2C0
  if( i2c_port == MIOS32_I2C_PORT_FMPI2C0 )
    return MIOS32_I2C_V2_TransferStart(&fmpi2c0_rec, transfer, address, buffer, len);
#endif

  if( i2c_port >= MIOS32_I2C_PORT_NUM || i2c_v1_rec[i2c_port] == NULL )
    return MIOS32_I2C_ERROR_INVALID_PORT;

  return MIOS32_I2C_V1_TransferStart(i2c_v1_rec[i2c_port], transfer, address, buffer, len);
}
...
s32 MIOS32_I2C_TransferCheck(u8 i2c_port)
{
  ...
  if( i2c_port == MIOS32_I2C_PORT_FMPI2C0 ) {
    if( fmpi2c0_rec.polled && fmpi2c0_rec.busy )
      MIOS32_I2C_V2_Step(&fmpi2c0_rec);
  ...
  {
    mios32_i2c_v1_rec_t *rec = i2c_v1_rec[i2c_port];
...
#ifdef MIOS32_USE_FMPI2C0
  if( i2c_port == MIOS32_I2C_PORT_FMPI2C0 )
    return MIOS32_I2C_V2_TransferWait(&fmpi2c0_rec);
#endif

  if( i2c_port >= MIOS32_I2C_PORT_NUM || i2c_v1_rec[i2c_port] == NULL )
    return MIOS32_I2C_ERROR_INVALID_PORT;

  return MIOS32_I2C_V1_TransferWait(i2c_v1_rec[i2c_port]);
}
...
MIOS32_I2C0_IRQHANDLER_EV_FUNC { MIOS32_I2C_V1_Step(&i2c0_rec); }
MIOS32_I2C0_IRQHANDLER_ER_FUNC { MIOS32_I2C_V1_Step(&i2c0_rec); }
#endif

#if defined(MIOS32_USE_I2C1) && !MIOS32_I2C1_POLLED
MIOS32_I2C1_IRQHANDLER_EV_FUNC { MIOS32_I2C_V1_Step(&i2c1_rec); }
MIOS32_I2C1_IRQHANDLER_ER_FUNC { MIOS32_I2C_V1_Step(&i2c1_rec); }
#endif

#if defined(MIOS32_USE_I2C2) && !MIOS32_I2C2_POLLED
MIOS32_I2C2_IRQHANDLER_EV_FUNC { MIOS32_I2C_V1_Step(&i2c2_rec); }
MIOS32_I2C2_IRQHANDLER_ER_FUNC { MIOS32_I2C_V1_Step(&i2c2_rec); }
#endif

#if defined(MIOS32_USE_FMPI2C0) && !MIOS32_FMPI2C0_POLLED
MIOS32_FMPI2C0_IRQHANDLER_EV_FUNC { MIOS32_I2C_V2_Step(&fmpi2c0_rec); }
MIOS32_FMPI2C0_IRQHANDLER_ER_FUNC { MIOS32_I2C_V2_Step(&fmpi2c0_rec); }
#endif
