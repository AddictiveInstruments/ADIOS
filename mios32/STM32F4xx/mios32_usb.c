...
void USB_OTG_BSP_Init(USB_OTG_CORE_HANDLE *pdev)
{
  ...
  GPIO_InitStructure.Pin = LL_GPIO_PIN_8 | LL_GPIO_PIN_9 | LL_GPIO_PIN_11 | LL_GPIO_PIN_12;
  ...
  LL_GPIO_SetAFPin_8_15(GPIOA, LL_GPIO_PIN_8, LL_GPIO_AF_10);
...
//  GPIO_PinAFConfig(GPIOA,GPIO_PIN_8,GPIO_AF_OTG1_FS) ;
//  GPIO_PinAFConfig(GPIOA,GPIO_PIN_9,GPIO_AF_OTG1_FS) ;
//  GPIO_PinAFConfig(GPIOA,GPIO_PIN_11,GPIO_AF_OTG1_FS) ;
//  GPIO_PinAFConfig(GPIOA,GPIO_PIN_12,GPIO_AF_OTG1_FS) ;
  ...
  //GPIO_PinAFConfig(GPIOA,GPIO_PIN_10,GPIO_AF_OTG1_FS) ;
...
//  RCC_AHB2PeriphClockCmd(RCC_AHB2Periph_OTG_FS, ENABLE) ;
  ...
  GPIO_PinAFConfig(GPIOB,GPIO_PIN_14,GPIO_AF_OTG2_FS) ;
  GPIO_PinAFConfig(GPIOB,GPIO_PIN_15,GPIO_AF_OTG2_FS) ;
...
void  USB_OTG_BSP_ConfigVBUS(USB_OTG_CORE_HANDLE *pdev)
{
  ...
  GPIO_SetBits(GPIOC, LL_GPIO_PIN_0);
  ...
  /* By Default, DISABLE is needed on output of the Power Switch */
  GPIO_SetBits(GPIOC, LL_GPIO_PIN_14);
...
void USB_OTG_BSP_DriveVBUS(USB_OTG_CORE_HANDLE *pdev, uint8_t state)
{
  ...
  */
  ...
  else
  {
    ...
    GPIO_ResetBits(GPIOC, LL_GPIO_PIN_0);
  }
	  }
#endif
#ifndef MIOS32_DONT_USE_USB_HS_HOST
  ...
  {
    /*ENABLE the Power Switch by driving the Enable LOW */
    GPIO_ResetBits(GPIOC, LL_GPIO_PIN_14);
  }
	  }
#endif
}
...
s32 MIOS32_USB_Init(u32 mode)
{
  ...
  if( MIOS32_USB_ForceDeviceMode() || MIOS32_SYS_STM_PINGET(GPIOA, LL_GPIO_PIN_10) ) {
