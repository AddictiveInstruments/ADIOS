...
#define MIOS32_UART0_CLOCK_FUNC  { LL_APB1_GRP1_EnableClock(LL_APB1_GRP1_PERIPH_USART2); }

#define MIOS32_UART1_TX_PORT     GPIOD
#define MIOS32_UART1_TX_PIN      LL_GPIO_PIN_8
#define MIOS32_UART1_RX_PORT     GPIOD
#define MIOS32_UART1_RX_PIN      LL_GPIO_PIN_9
...
#define MIOS32_UART1_REMAP_FUNC  { LL_GPIO_SetAFPin_8_15(GPIOD, LL_GPIO_PIN_8, LL_GPIO_AF_7); LL_GPIO_SetAFPin_8_15(GPIOD, LL_GPIO_PIN_9, LL_GPIO_AF_7); }
#define MIOS32_UART1_CLOCK_FUNC  { LL_APB1_GRP1_EnableClock(LL_APB1_GRP1_PERIPH_USART3); }
...
#define MIOS32_UART2_TX_PIN      LL_GPIO_PIN_6
#define MIOS32_UART2_RX_PORT     GPIOB
#define MIOS32_UART2_RX_PIN      LL_GPIO_PIN_7
...
#define MIOS32_UART2_REMAP_FUNC  { LL_GPIO_SetAFPin_0_7(GPIOC, LL_GPIO_PIN_6, LL_GPIO_AF_8); LL_GPIO_SetAFPin_0_7(GPIOB, LL_GPIO_PIN_7, LL_GPIO_AF_7); }
#define MIOS32_UART2_CLOCK_FUNC  { LL_APB2_GRP1_EnableClock(LL_APB2_GRP1_PERIPH_USART6 | LL_APB2_GRP1_PERIPH_USART1); }

#define MIOS32_UART3_TX_PORT     GPIOC
#define MIOS32_UART3_TX_PIN      LL_GPIO_PIN_12
#define MIOS32_UART3_RX_PORT     GPIOD
#define MIOS32_UART3_RX_PIN      LL_GPIO_PIN_2
...
#define MIOS32_UART3_REMAP_FUNC  { LL_GPIO_SetAFPin_8_15(GPIOC, LL_GPIO_PIN_12, LL_GPIO_AF_8); LL_GPIO_SetAFPin_0_7(GPIOD, LL_GPIO_PIN_2, LL_GPIO_AF_8); }
#define MIOS32_UART3_CLOCK_FUNC  { LL_APB1_GRP1_EnableClock(LL_APB1_GRP1_PERIPH_UART5); }
...
#define MIOS32_UART0_TX_PORT     GPIOA
#define MIOS32_UART0_TX_PIN      LL_GPIO_PIN_2
#define MIOS32_UART0_TX_ALT      LL_GPIO_AF_7
#define MIOS32_UART0_RX_PORT     GPIOA
#define MIOS32_UART0_RX_PIN      LL_GPIO_PIN_3
#define MIOS32_UART0_RX_ALT      LL_GPIO_AF_7
#define MIOS32_UART0             USART2
#define MIOS32_UART0_IRQ_CHANNEL USART2_IRQn
#define MIOS32_UART0_IRQHANDLER_FUNC void USART2_IRQHandler(void)
//#define MIOS32_UART0_REMAP_FUNC  { LL_GPIO_SetAFPin_0_7(GPIOA, LL_GPIO_PIN_2, LL_GPIO_AF_7); LL_GPIO_SetAFPin_0_7(GPIOA, LL_GPIO_PIN_3, LL_GPIO_AF_7); }
...
#define MIOS32_UART1_TX_ALT      LL_GPIO_AF_8
#define MIOS32_UART1_RX_PORT     GPIOC
#define MIOS32_UART1_RX_PIN      LL_GPIO_PIN_11
#define MIOS32_UART1_RX_ALT      LL_GPIO_AF_8
...
s32 MIOS32_UART_Init(u32 mode)
{
  ...
  LL_USART_EnableIT_RXNE(MIOS32_UART2_RX);
...
#endif
#if NUM_SUPPORTED_UARTS >= 3 && MIOS32_UART2_ASSIGNMENT != 0
  LL_USART_Enable(MIOS32_UART2_RX);
  LL_USART_Enable(MIOS32_UART2_TX);
...
s32 MIOS32_UART_BaudrateSet(u8 uart, u32 baudrate)
{
  ...
  case 0:
	  ...
	  LL_USART_SetBaudRate(MIOS32_UART0, 42000000, LL_USART_OVERSAMPLING_16, baudrate);
	  break;
#if NUM_SUPPORTED_UARTS >= 2
  case 1:
	  LL_USART_Init(MIOS32_UART1, &USART_InitStructure);
	  LL_USART_ConfigAsyncMode(MIOS32_UART1);
	  LL_USART_SetBaudRate(MIOS32_UART1, 42000000, LL_USART_OVERSAMPLING_16, baudrate);
	  break;
#endif
#if NUM_SUPPORTED_UARTS >= 3
  case 2: LL_USART_Init(MIOS32_UART2_TX, &USART_InitStructure); LL_USART_Init(MIOS32_UART2_RX, &USART_InitStructure); break;
#endif
#if NUM_SUPPORTED_UARTS >= 4
  case 3: LL_USART_Init(MIOS32_UART3, &USART_InitStructure); break;
#endif
  default:
