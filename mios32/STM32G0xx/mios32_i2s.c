...
//! mios32_config.h<BR>
//! MIOS32_SRIO should either be left undeclared, or 
...
#define MIOS32_I2S_WS_PIN    LL_GPIO_PIN_4
#define MIOS32_I2S_WS_PINSRC GPIO_PIN_4

#define MIOS32_I2S_CK_PORT   GPIOC
#define MIOS32_I2S_CK_PIN    LL_GPIO_PIN_10
#define MIOS32_I2S_CK_PINSRC GPIO_PIN_10

#define MIOS32_I2S_SD_PORT   GPIOC
#define MIOS32_I2S_SD_PIN    LL_GPIO_PIN_12
#define MIOS32_I2S_SD_PINSRC GPIO_PIN_12

#define MIOS32_I2S_MCLK_PORT GPIOC
#define MIOS32_I2S_MCLK_PIN  LL_GPIO_PIN_7
#define MIOS32_I2S_MCLK_PINSRC GPIO_PIN_7
...
s32 MIOS32_I2S_Init(u32 mode)
{
  ...
  GPIO_InitStructure.Pin = MIOS32_I2S_WS_PIN;
  LL_GPIO_Init(MIOS32_I2S_WS_PORT, &GPIO_InitStructure);
  GPIO_PinAFConfig(MIOS32_I2S_WS_PORT, MIOS32_I2S_WS_PINSRC, GPIO_AF_SPI3);

  GPIO_InitStructure.Pin = MIOS32_I2S_CK_PIN;
  LL_GPIO_Init(MIOS32_I2S_CK_PORT, &GPIO_InitStructure);
  GPIO_PinAFConfig(MIOS32_I2S_CK_PORT, MIOS32_I2S_CK_PINSRC, GPIO_AF_SPI3);

  GPIO_InitStructure.Pin = MIOS32_I2S_SD_PIN;
  LL_GPIO_Init(MIOS32_I2S_SD_PORT, &GPIO_InitStructure);
  GPIO_PinAFConfig(MIOS32_I2S_SD_PORT, MIOS32_I2S_SD_PINSRC, GPIO_AF_SPI3);

#if MIOS32_I2S_MCLK_ENABLE
  GPIO_InitStructure.Pin = MIOS32_I2S_MCLK_PIN;
  LL_GPIO_Init(MIOS32_I2S_MCLK_PORT, &GPIO_InitStructure);
