...
#endif
// CAN1 pins, overridable from mios32_config.h. No STM32G0 in the tree
// carries a CAN peripheral, so MIOS32_CAN_NUM is 0 here and none of this is
// reached - it is kept aligned with the F4 driver so the two stay readable
// side by side.
#define MIOS32_CAN1             CAN1
#ifndef MIOS32_CAN1_RX_PORT
#define MIOS32_CAN1_RX_PORT     GPIOB
...
#define MIOS32_CAN2_RX_PIN      LL_GPIO_PIN_5
#define MIOS32_CAN2_TX_PORT     GPIOB
#define MIOS32_CAN2_TX_PIN      LL_GPIO_PIN_6
#define MIOS32_CAN2_REMAP_FUNC  { GPIO_PinAFConfig(GPIOB, GPIO_PIN_5, GPIO_AF_CAN2); GPIO_PinAFConfig(GPIOB, GPIO_PIN_5, GPIO_AF_CAN2); }
#else                           //  1: CAN2.RX->PB12, CAN2.TX->PB13
#define MIOS32_CAN2_RX_PORT     GPIOB
#define MIOS32_CAN2_RX_PIN      LL_GPIO_PIN_12
#define MIOS32_CAN2_TX_PORT     GPIOB
#define MIOS32_CAN2_TX_PIN      LL_GPIO_PIN_13
#define MIOS32_CAN2_REMAP_FUNC  { GPIO_PinAFConfig(GPIOB, GPIO_PIN_12, GPIO_AF_CAN2); GPIO_PinAFConfig(GPIOB, GPIO_PIN_13, GPIO_AF_CAN2); }
#endif
...
s32 MIOS32_CAN_InitPort(u8 can, u8 is_midi)
{
  ...
  switch( can ) {
    ...
    case 0: {
      ...
      GPIO_InitStructure.Pin = MIOS32_CAN1_RX_PIN;
      LL_GPIO_Init(MIOS32_CAN1_RX_PORT, &GPIO_InitStructure);
      
      GPIO_InitStructure.Mode  = GPIO_Mode_AF;
      GPIO_InitStructure.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
      GPIO_InitStructure.Pull  = LL_GPIO_PULL_NO;
      GPIO_InitStructure.Pin = MIOS32_CAN1_TX_PIN;
      LL_GPIO_Init(MIOS32_CAN1_TX_PORT, &GPIO_InitStructure);
    } break;
#endif
    ...
    case 1: {
      ...
      GPIO_InitStructure.Pin = MIOS32_CAN2_RX_PIN;
      LL_GPIO_Init(MIOS32_CAN2_RX_PORT, &GPIO_InitStructure);
      
      GPIO_InitStructure.Mode  = GPIO_Mode_AF;
      GPIO_InitStructure.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
      GPIO_InitStructure.Pin = MIOS32_CAN2_TX_PIN;
      LL_GPIO_Init(MIOS32_CAN2_TX_PORT, &GPIO_InitStructure);
    } break;
#endif
