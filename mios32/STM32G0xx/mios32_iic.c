...
#define MIOS32_IIC0_SCL_PIN     LL_GPIO_PIN_10
#define MIOS32_IIC0_SCL_AF      { GPIO_PinAFConfig(GPIOB, GPIO_PIN_10, GPIO_AF_I2C2); }
#define MIOS32_IIC0_SDA_PORT    GPIOB
#define MIOS32_IIC0_SDA_PIN     LL_GPIO_PIN_11
#define MIOS32_IIC0_SDA_AF      { GPIO_PinAFConfig(GPIOB, GPIO_PIN_11, GPIO_AF_I2C2); }

#define MIOS32_IIC1_SCL_PORT    GPIOB
#define MIOS32_IIC1_SCL_PIN     LL_GPIO_PIN_6
#define MIOS32_IIC1_SCL_AF      { GPIO_PinAFConfig(GPIOB, GPIO_PIN_6, GPIO_AF_I2C1); }
# if defined(MIOS32_BOARD_STM32F4DISCOVERY) || defined(MIOS32_BOARD_MBHP_CORE_STM32F4)
#define MIOS32_IIC1_SDA_PORT    GPIOB
#define MIOS32_IIC1_SDA_PIN     LL_GPIO_PIN_9
#define MIOS32_IIC1_SDA_AF      { GPIO_PinAFConfig(GPIOB, GPIO_PIN_9, GPIO_AF_I2C1); }
# elif defined(MIOS32_BOARD_MBHP_DIPCOREF4)
#define MIOS32_IIC1_SDA_PORT    GPIOB
#define MIOS32_IIC1_SDA_PIN     LL_GPIO_PIN_7
#define MIOS32_IIC1_SDA_AF      { GPIO_PinAFConfig(GPIOB, GPIO_PIN_7, GPIO_AF_I2C1); }
#endif
/////////////////////////////////////////////////////////////////////////////
...
s32 MIOS32_IIC_Init(u32 mode)
{
  ...
  GPIO_InitStructure.Pin = MIOS32_IIC0_SCL_PIN;
  LL_GPIO_Init(MIOS32_IIC0_SCL_PORT, &GPIO_InitStructure);
  MIOS32_IIC0_SCL_AF;

  GPIO_InitStructure.Pin = MIOS32_IIC0_SDA_PIN;
  LL_GPIO_Init(MIOS32_IIC0_SDA_PORT, &GPIO_InitStructure);
  MIOS32_IIC0_SDA_AF;

#if MIOS32_IIC_NUM >= 2
  GPIO_InitStructure.Pin = MIOS32_IIC1_SCL_PIN;
  LL_GPIO_Init(MIOS32_IIC1_SCL_PORT, &GPIO_InitStructure);
  MIOS32_IIC1_SCL_AF;

  GPIO_InitStructure.Pin = MIOS32_IIC1_SDA_PIN;
  LL_GPIO_Init(MIOS32_IIC1_SDA_PORT, &GPIO_InitStructure);
  MIOS32_IIC1_SDA_AF;
#endif
