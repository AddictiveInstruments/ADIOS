...
#define ADIOS_APP_NAME1 "F4 dual role USB"
#define ADIOS_APP_NAME2 "one micro-AB, ID decides"
...
#define ADIOS_USB_PRODUCT_STR  "F4 dual role"
...
// Read as a plain input - adios_usb_ll.c explains why it is deliberately NOT
...
// the bus.
#define ADIOS_USB_P0_VBUS_PORT    GPIOA
#define ADIOS_USB_P0_VBUS_PIN     LL_GPIO_PIN_3

// That switch's over-current flag: open drain, asserted low.
#define ADIOS_USB_P0_OC_PORT      GPIOA
#define ADIOS_USB_P0_OC_PIN       LL_GPIO_PIN_5
...
// in BOTH roles - while ADIOS_MIDI_DEFAULT_PORT stays USB0 above, so uploads
...
/////////////////////////////////////////////////////////////////////////////
#define ADIOS_MIDI_DEBUG_PORT     DIN1
#define ADIOS_USE_DIN_MIDI
#define ADIOS_USE_UART1
#define ADIOS_UART1_RX_PORT       GPIOD
#define ADIOS_UART1_RX_PIN        LL_GPIO_PIN_6
#define ADIOS_UART1_CLOCK_FUNC    { LL_APB1_GRP1_EnableClock(LL_APB1_GRP1_PERIPH_USART2); LL_AHB1_GRP1_EnableClock(LL_AHB1_GRP1_PERIPH_GPIOA); LL_AHB1_GRP1_EnableClock(LL_AHB1_GRP1_PERIPH_GPIOD); }
