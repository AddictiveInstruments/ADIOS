...
#define ADIOS_APP_NAME1 "App. Template"
#define ADIOS_APP_NAME2 "(C) 2009 <your name>"
...
// reserved flash size (in bytes, offset from 0x08000000) for the bootloader on this project.
// must match the value the bootloader itself was built with (see bootloader/src/adios_config.h)
// and the FLASH origin used by this project's linker script.
// mandatory as soon as the bootloader is used (ADIOS_MIDI_BSL_ENHANCEMENTS / BSL image included).
