...
// must match the value the bootloader itself was built with (see bootloader/src/mios32_config.h)
// and the FLASH origin used by this project's linker script.
// mandatory as soon as the bootloader is used (MIOS32_MIDI_BSL_ENHANCEMENTS / BSL image included).
