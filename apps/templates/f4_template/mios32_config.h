...
#define MIOS32_APP_NAME1 "F4 template"
...
// stack also needs MIOS32_USE_TIMESTAMP, which it will tell you about.
...
#define MIOS32_USB_PRODUCT_STR  "F4 template"
...
#define MIOS32_HEAP_SIZE 8*1024   // 8 Ko : la pile USB hote demande une pile de tache plus grande, et toutes les piles sortent de ce tas
#endif
