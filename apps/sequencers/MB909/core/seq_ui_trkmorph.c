...
//  SEQ_LCD_PrintString("Trk. Mode  Dst.Range               Value");
  ...
  if( !seq_midi_in_ext_ctrl_channel || seq_midi_in_ext_ctrl_asg[SEQ_MIDI_IN_EXT_CTRL_MORPH] >= 0x80 ) {
    SEQ_LCD_PrintString("Please enable Ext.   ");
	
	SEQ_LCD_CursorSet(0, 2);	
	SEQ_LCD_PrintString("Ctrl in the MIDI page");
  } else {
    SEQ_LCD_PrintString("Morphing controlled  ");
	SEQ_LCD_PrintFormattedString("by %s/Chn%2d CC#%3d",
...
*/
  ...
  ///////////////////////////////////////////////////////////////////////////
  SEQ_LCD_PrintString("<");
  SEQ_LCD_PrintLongHBar((SEQ_MORPH_ValueGet())/2);
  SEQ_LCD_CursorSet(20, 3);  
  SEQ_LCD_PrintString(">");

  ///////////////////////////////////////////////////////////////////////////
  SEQ_LCD_CursorSet(0, 4);
  ///////////////////////////////////////////////////////////////////////////
  if( ui_selected_item == ITEM_MORPH_MODE ) {
	SEQ_LCD_FontInit((u8 *)GLCD_FONT_NORMAL_INV);
...
//  }
  ...
  ///////////////////////////////////////////////////////////////////////////
  if( ui_selected_item == ITEM_MORPH_DST ) {
	SEQ_LCD_FontInit((u8 *)GLCD_FONT_NORMAL_INV);
    SEQ_LCD_PrintString("Dst.Range: ");
	SEQ_LCD_FontInit((u8 *)GLCD_FONT_NORMAL);
  } else {
    SEQ_LCD_FontInit((u8 *)GLCD_FONT_NORMAL);
	SEQ_LCD_PrintString("Dst.Range: ");
...
//  SEQ_LCD_CursorSet(19, 1); // set back cursor
  ...
  ///////////////////////////////////////////////////////////////////////////
  if( ui_selected_item == ITEM_MORPH_VALUE ) {
	SEQ_LCD_FontInit((u8 *)GLCD_FONT_NORMAL_INV);
