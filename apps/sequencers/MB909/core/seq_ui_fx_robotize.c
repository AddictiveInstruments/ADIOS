...
static s32 LCD_Handler(u8 high_prio)
{
  ...
  SEQ_LCD_PrintString(" TRCK Fx ROBOTIZE"); 
...
*/
  ///////////////////////////////////////////////////////////////////////////
  if( ui_selected_item == ITEM_ROBOTIZE_ACTIVE ) {
	SEQ_LCD_FontInit((u8 *)GLCD_FONT_NORMAL_INV);
    SEQ_LCD_PrintString("Robot: ");
	SEQ_LCD_FontInit((u8 *)GLCD_FONT_NORMAL);
  } else {
    SEQ_LCD_FontInit((u8 *)GLCD_FONT_NORMAL);
	SEQ_LCD_PrintString("Robot: ");
...
//  }
  ...
  ///////////////////////////////////////////////////////////////////////////
  if( ui_selected_item == ITEM_ROBOTIZE_PROBABILITY ) {
	SEQ_LCD_FontInit((u8 *)GLCD_FONT_NORMAL_INV);
    SEQ_LCD_PrintString("Prob: ");
	SEQ_LCD_FontInit((u8 *)GLCD_FONT_NORMAL);
  } else {
    SEQ_LCD_FontInit((u8 *)GLCD_FONT_NORMAL);
	SEQ_LCD_PrintString("Prob: ");
...
//  }
  ...
  if( ui_selected_item == ITEM_ROBOTIZE_SKIP ) {
	SEQ_LCD_FontInit((u8 *)GLCD_FONT_NORMAL_INV);
...
//  }
  ...
  ///////////////////////////////////////////////////////////////////////////
  if( ui_selected_item == ITEM_ROBOTIZE_OCTAVE ) {
	SEQ_LCD_FontInit((u8 *)GLCD_FONT_NORMAL_INV);
    SEQ_LCD_PrintString("Octv: ");
	SEQ_LCD_FontInit((u8 *)GLCD_FONT_NORMAL);
  } else {
    SEQ_LCD_FontInit((u8 *)GLCD_FONT_NORMAL);
	SEQ_LCD_PrintString("Octv: ");
  ...
  if( ui_selected_item == ITEM_ROBOTIZE_NOTE ) {
	SEQ_LCD_FontInit((u8 *)GLCD_FONT_NORMAL_INV);
  ...
  ///////////////////////////////////////////////////////////////////////////
  if( ui_selected_item == ITEM_ROBOTIZE_VELOCITY ) {
	SEQ_LCD_FontInit((u8 *)GLCD_FONT_NORMAL_INV);
    SEQ_LCD_PrintString("VelCC:");
	SEQ_LCD_FontInit((u8 *)GLCD_FONT_NORMAL);
  } else {
    SEQ_LCD_FontInit((u8 *)GLCD_FONT_NORMAL);
	SEQ_LCD_PrintString("VelCC:");
  ...
  if( ui_selected_item == ITEM_ROBOTIZE_LENGTH ) {
	SEQ_LCD_FontInit((u8 *)GLCD_FONT_NORMAL_INV);
...
///////////////////////////////////////////////////////////////////////////
  if( ui_selected_item == ITEM_ROBOTIZE_SUSTAIN ) {
	SEQ_LCD_FontInit((u8 *)GLCD_FONT_NORMAL_INV);
    SEQ_LCD_PrintString("Sust: ");
	SEQ_LCD_FontInit((u8 *)GLCD_FONT_NORMAL);
  } else {
    SEQ_LCD_FontInit((u8 *)GLCD_FONT_NORMAL);
	SEQ_LCD_PrintString("Sust: ");
...
//  }
  ...
  if( ui_selected_item == ITEM_ROBOTIZE_NOFX ) {
	SEQ_LCD_FontInit((u8 *)GLCD_FONT_NORMAL_INV);
...
//  }
  ...
  ///////////////////////////////////////////////////////////////////////////
  if( ui_selected_item == ITEM_ROBOTIZE_ECHO ) {
	SEQ_LCD_FontInit((u8 *)GLCD_FONT_NORMAL_INV);
...
//  } else {
 ...
 // }
  ...
  if( ui_selected_item == ITEM_ROBOTIZE_DUPLICATE ) {
	SEQ_LCD_FontInit((u8 *)GLCD_FONT_NORMAL_INV);
    SEQ_LCD_PrintString("+Dup: ");
	SEQ_LCD_FontInit((u8 *)GLCD_FONT_NORMAL);
  } else {
    SEQ_LCD_FontInit((u8 *)GLCD_FONT_NORMAL);
	SEQ_LCD_PrintString("+Dup: ");
