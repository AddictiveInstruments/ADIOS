...
extern s32 SEQ_LCD_FontInit(u8 *font);
extern s32 SEQ_LCD_Contrastset(u8 lcd_contrast);
extern s32 SEQ_LCD_Contrastget(void);

extern s32 SEQ_LCD_Clear(void);
extern s32 SEQ_LCD_PrintChar(char c);
extern s32 SEQ_LCD_CursorSet(u16 column, u16 line);
extern s32 SEQ_LCD_DrawHLine(u16 column, u16 line, u8 width);
