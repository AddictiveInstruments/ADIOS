// $Id: seq_ui_fx_scale.c 2102 2014-12-15 17:40:04Z tk $
/*
 * Scale Fx page
 *
 * ==========================================================================
...
static s32 LCD_Handler(u8 high_prio)
{
  ...
  if( ui_selected_item == ITEM_SCALE_CTRL ) {
	SEQ_LCD_FontInit((u8 *)GLCD_FONT_NORMAL_INV);
    SEQ_LCD_PrintString("Control: ");
...
//  }
  ...
  if( ui_selected_item == ITEM_SCALE_ROOT ) {
	SEQ_LCD_FontInit((u8 *)GLCD_FONT_NORMAL_INV);
    SEQ_LCD_PrintString("Root   : ");
	SEQ_LCD_FontInit((u8 *)GLCD_FONT_NORMAL);
  } else {
    SEQ_LCD_FontInit((u8 *)GLCD_FONT_NORMAL);
	SEQ_LCD_PrintString("Root   : ");
...
//  }
  ...
  if( ui_selected_item == ITEM_SCALE ) {
	SEQ_LCD_FontInit((u8 *)GLCD_FONT_NORMAL_INV);
    SEQ_LCD_PrintString("Selected Scale: ");
	SEQ_LCD_FontInit((u8 *)GLCD_FONT_NORMAL);
  } else {
    SEQ_LCD_FontInit((u8 *)GLCD_FONT_NORMAL);
	SEQ_LCD_PrintString("Selected Scale: ");
