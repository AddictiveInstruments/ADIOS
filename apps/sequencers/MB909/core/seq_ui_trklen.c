...
static s32 Button_Handler(seq_ui_button_t button, s32 depressed)
{
  ...
  switch( button ) {
    ...
    case SEQ_UI_BUTTON_GP8:
      return Encoder_Handler((int)button+8, 1);	
...
static s32 LCD_Handler(u8 high_prio)
{
  ...
  /////////////////////////////////////////////////////////////////////////// 	
   	if( ui_selected_item == ITEM_LENGTH ) {		
		SEQ_LCD_FontInit((u8 *)GLCD_FONT_NORMAL_INV);
		SEQ_LCD_PrintString("Length");
		SEQ_LCD_FontInit((u8 *)GLCD_FONT_NORMAL);	
...
//  if( ui_selected_item == ITEM_LENGTH ) {
 // } else {
    ...
    if( len > num_steps )
	  ...
	  SEQ_LCD_FontInit((u8 *)GLCD_FONT_NORMAL);
	  SEQ_LCD_PrintFormattedString("%3d / %d", len, num_steps);
	}  
...
//  } else {
    ...
    if( loop > num_steps )
	  ...
	  SEQ_LCD_FontInit((u8 *)GLCD_FONT_NORMAL);
      SEQ_LCD_PrintFormattedString("%3d - %d", loop, len);
	}
	SEQ_LCD_PrintSpaces(3);	
 // }
  ...
  ///////////////////////////////////////////////////////////////////////////   
   	...
   	if( ui_selected_item == ITEM_QUICKSEL_MODE ) {		
		SEQ_LCD_FontInit((u8 *)GLCD_FONT_NORMAL_INV);
  ...
  /////////////////////////////////////////////////////////////////////////// 
	SEQ_LCD_PrintString("(use GP buttons 1-8)");
  ///////////////////////////////////////////////////////////////////////////
