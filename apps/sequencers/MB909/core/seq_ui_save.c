...
static s32 LCD_Handler(u8 high_prio)
{
  ...
  if( edit_label_mode ) {
	...
	SEQ_LCD_PrintString("Please enter Pattern ");

    SEQ_LCD_CursorSet(0, 1);
    SEQ_LCD_PrintString((ui_edit_name_cursor < 5) ? "Category for " : "Label for ");
    
	SEQ_LCD_PrintFormattedString("%d", save_pattern[ui_selected_group].bank+1);
    SEQ_LCD_PrintChar(':');
    SEQ_LCD_PrintPattern(save_pattern[ui_selected_group]);
    SEQ_LCD_PrintSpaces((ui_edit_name_cursor < 5) ? 4 : 7);
    ...
    if( ui_cursor_flash ) {
	  ...
	  SEQ_LCD_CursorSet(0 + ((ui_edit_name_cursor < 5) ? 1 : 2) + ui_edit_name_cursor, 2);
      SEQ_LCD_PrintChar('*');
    }
  ...
  ///////////////////////////////////////////////////////////////////////////
  SEQ_LCD_CursorSet(0, 0);
  SEQ_LCD_PrintString("    SAVE PATTERN     ");
  
  ///////////////////////////////////////////////////////////////////////////
  SEQ_LCD_CursorSet(0, 1);
  if( ui_selected_item == ITEM_GROUP ) {
...
// if( ui_selected_item == ITEM_GROUP && ui_cursor_flash ) {
 ...
 // }
  ...
  ///////////////////////////////////////////////////////////////////////////
	SEQ_LCD_CursorSet(0, 2);
	SEQ_LCD_PrintString("Save to Target> ");
  ///////////////////////////////////////////////////////////////////////////  
	//SEQ_LCD_CursorSet(0, 2);
	//SEQ_LCD_PrintString("------>              "); 
  ///////////////////////////////////////////////////////////////////////////
	//SEQ_LCD_CursorSet(0, 3);
  if( ui_selected_item == ITEM_BANK ) {
  ...
  if( ui_selected_item == ITEM_PATTERN ) {
  ...
  if( ui_selected_item == ITEM_BANK || ui_selected_item == ITEM_PATTERN ) {
    ...
    SEQ_LCD_PrintFormattedString("%1d", save_pattern[ui_selected_group].bank+1);
    SEQ_LCD_PrintChar(':');
    SEQ_LCD_PrintPattern(save_pattern[ui_selected_group]);
    SEQ_LCD_PrintString(" preview on Disk: ");
