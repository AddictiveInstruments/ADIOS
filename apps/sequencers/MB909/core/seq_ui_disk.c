...
#define SESSION_NUM_OF_ITEMS      5
#define SESSION_ITEM_FILE         0
#define SESSION_ITEM_TYPE         1
#define SESSION_ITEM_PATTERN_B    2
#define SESSION_ITEM_PATTERN_E    3
#define SESSION_ITEM_PATTERN_D    4
...
*/
	...
	if( SEQ_UI_Var8_Inc(&ui_selected_item, 0, SESSION_NUM_OF_ITEMS-1, incrementer) >= 0 )
		return 1;
	else
		return 0; 	
 ...
 if (encoder == SEQ_UI_ENCODER_Datawheel) { 
    ...
    case DIALOG_MF_EXPORT: {
      ...
      switch( encoder ) {
    case SEQ_UI_ENCODER_GP1:
	if( SEQ_UI_Var8_Inc(&ui_selected_item, 0, EXPORT_NUM_OF_ITEMS-1, incrementer) >= 0 )
		return 1;
	else
		return 0; 	
      //ui_selected_item = ITEM_GXTY;
  ...
  switch( menu_dialog ) {
    ...
    case DIALOG_S_EXPORT: {
      ...
      if( dir_num_items < 0 ) {
			...
			if( menu_dialog == DIALOG_S_IMPORT ){
				SEQ_LCD_PrintString("Select Source       ");
				SEQ_LCD_CursorSet(0, 1);
				SEQ_LCD_PrintFormattedString("Session (%d found)", dir_num_items);
			}else{
				SEQ_LCD_PrintString("Select Source       ");
				SEQ_LCD_CursorSet(0, 1);
				SEQ_LCD_PrintFormattedString("Session (%d found)", dir_num_items);
      ...
      SEQ_LCD_PrintString("Type Source         ");
	  SEQ_LCD_CursorSet(0, 6);
      SEQ_LCD_PrintString("Destination         ");
	...
	SEQ_LCD_PrintChar(dir_name[i]);
      ...
      if( ui_cursor_flash ) {
	SEQ_LCD_CursorSet(7 + ui_edit_name_cursor, 2);
	SEQ_LCD_PrintChar('*');
      }
    ...
    default:
      ///////////////////////////////////////////////////////////////////////////
      SEQ_LCD_CursorSet(0, 1);
      SEQ_LCD_PrintString("Import Sessions     ");
      //SEQ_LCD_PrintSpaces(40);

      ///////////////////////////////////////////////////////////////////////////
      SEQ_LCD_CursorSet(0, 2);
      SEQ_LCD_PrintString("Export Sessions     ");
	  
      ///////////////////////////////////////////////////////////////////////////
      SEQ_LCD_CursorSet(0, 3);	  
	  SEQ_LCD_PrintString("Import MIDI Files");

      ///////////////////////////////////////////////////////////////////////////	  
      SEQ_LCD_CursorSet(0, 4);
      SEQ_LCD_PrintString("Export MIDI Files");

      ///////////////////////////////////////////////////////////////////////////	  
      SEQ_LCD_CursorSet(0, 5);
      SEQ_LCD_PrintString("Play MIDI Files");
  }
