...
//      SEQ_LCD_CursorSet(5*port_ix, 1);
	  switch( port_ix ) {
		case 0:
			...
			break;
		case 4:
			SEQ_LCD_CursorSet(5*(port_ix-4), 3);
			break;
		case 8:
			SEQ_LCD_CursorSet(5*(port_ix-8), 5);
			break;
		case 12:
			SEQ_LCD_CursorSet(5*(port_ix-12), 7);
			break;
		}
...
//    SEQ_LCD_CursorSet(5*port_ix, 0);
	  switch( port_ix ) {
		case 0:
			...
			break;
		case 4:
			SEQ_LCD_CursorSet(5*(port_ix-4), 2);
			break;
		case 8:
			SEQ_LCD_CursorSet(5*(port_ix-8), 4);
			break;
		case 12:
			SEQ_LCD_CursorSet(5*(port_ix-12), 6);
			break;
		}
    if( ui_cursor_flash && seq_ui_button_state.SELECT_PRESSED )
    ...
    //SEQ_LCD_CursorSet(5*port_ix, 0);
	  switch( port_num ) {
		case 1:
			...
			break;
		case 5:
			SEQ_LCD_CursorSet(5*(port_ix-5), 2);
			break;
		case 9:
			SEQ_LCD_CursorSet(5*(port_ix-9), 4);
			break;
		case 13:
			SEQ_LCD_CursorSet(5*(port_ix-13), 6);
			break;
		}	
    ...
    //SEQ_LCD_CursorSet(5*port_ix, 1);
	  switch( port_ix ) {
		case 1:
			...
			break;
		case 5:
			SEQ_LCD_CursorSet(5*(port_ix-5), 3);
			break;
		case 9:
			SEQ_LCD_CursorSet(5*(port_ix-9), 5);
			break;
		case 13:
			SEQ_LCD_CursorSet(5*(port_ix-13), 7);
			break;
		}	
    SEQ_LCD_PrintSpaces(5*blank_slots);
  }
