...
static s32 LCD_Handler(u8 high_prio)
{
  ...
  for(i=0; i<SEQ_TRG_ASG_NUM; ++i) {  
 		switch( i ) {
			case 0:
				SEQ_LCD_CursorSet(5, 2);
				break;
			case 1:
				SEQ_LCD_CursorSet(16, 2);
				break;			
			case 2:
				SEQ_LCD_CursorSet(5, 3);
				break;			
			case 3:
				SEQ_LCD_CursorSet(16, 3);
				break;			
			case 4:
				SEQ_LCD_CursorSet(5, 4);
				break;
			case 5:
				SEQ_LCD_CursorSet(16, 4);
				break;			
			case 6:
				SEQ_LCD_CursorSet(5, 5);
				break;			
			case 7:
