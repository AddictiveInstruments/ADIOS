...
static s32 LED_Handler(u16 *gp_leds)
{
  ...
  switch( ui_selected_item ) {
    case ITEM_LOOP_MODE: *gp_leds = 0x0000; break;
    case ITEM_LOOP_OFFSET: *gp_leds = 0x0000; break;
    case ITEM_LOOP_STEPS: *gp_leds = 0x0000; break;
    case ITEM_LOOP_ACTIVE: *gp_leds = 0x0000; break;
  }
...
static s32 LCD_Handler(u8 high_prio)
{
  ...
  SEQ_LCD_PrintString("  GLOBAL LOOP MODE   ");
  //SEQ_LCD_PrintSpaces(34);


  ///////////////////////////////////////////////////////////////////////////
  SEQ_LCD_CursorSet(0, 1);
  if( ui_selected_item == ITEM_LOOP_MODE ) {
	SEQ_LCD_FontInit((u8 *)GLCD_FONT_NORMAL_INV);
    SEQ_LCD_PrintString("Loop mode: ");
...
//  } else {
    const char loop_mode_str[SEQ_CORE_NUM_LOOP_MODES][22] = {
      "All Tracks/Step View ",
      "All Trks/Static Steps",
      "Sel. Track/Step View ",
...
//  }
  ...
  if( ui_selected_item == ITEM_LOOP_OFFSET ) {
	SEQ_LCD_FontInit((u8 *)GLCD_FONT_NORMAL_INV);
    SEQ_LCD_PrintString("Offset: ");
	SEQ_LCD_FontInit((u8 *)GLCD_FONT_NORMAL);
  } else {
    SEQ_LCD_FontInit((u8 *)GLCD_FONT_NORMAL);
	SEQ_LCD_PrintString("Offset: ");
...
//  } else {
 ...
 // }
  SEQ_LCD_PrintSpaces(10);
//  SEQ_LCD_PrintString("Offset Steps     Loop");

  ///////////////////////////////////////////////////////////////////////////
  SEQ_LCD_CursorSet(0, 4);   
  if( ui_selected_item == ITEM_LOOP_STEPS ) {
	SEQ_LCD_FontInit((u8 *)GLCD_FONT_NORMAL_INV);
...
//  }
  ...
  ///////////////////////////////////////////////////////////////////////////
  if( ui_selected_item == ITEM_LOOP_ACTIVE ) {
	SEQ_LCD_FontInit((u8 *)GLCD_FONT_NORMAL_INV);
