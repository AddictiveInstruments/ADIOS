...
static s32 LCD_Handler(u8 high_prio)
{
  ...
  SEQ_LCD_PrintString(" TRACK ECHO Fx");
...
*/
  ///////////////////////////////////////////////////////////////////////////
  if( ui_selected_item == ITEM_ENABLE ) {
	SEQ_LCD_FontInit((u8 *)GLCD_FONT_NORMAL_INV);
...
//  }
  ...
  ///////////////////////////////////////////////////////////////////////////
  if( ui_selected_item == ITEM_REPEATS ) {
	SEQ_LCD_FontInit((u8 *)GLCD_FONT_NORMAL_INV);
    SEQ_LCD_PrintString("Repeats: ");
	SEQ_LCD_FontInit((u8 *)GLCD_FONT_NORMAL);
  } else {
    SEQ_LCD_FontInit((u8 *)GLCD_FONT_NORMAL);
	SEQ_LCD_PrintString("Repeats: ");
...
//  }
  ...
  if( ui_selected_item == ITEM_DELAY ) {
	SEQ_LCD_FontInit((u8 *)GLCD_FONT_NORMAL_INV);
    SEQ_LCD_PrintString("Delay:");
	SEQ_LCD_FontInit((u8 *)GLCD_FONT_NORMAL);
  } else {
    SEQ_LCD_FontInit((u8 *)GLCD_FONT_NORMAL);
	SEQ_LCD_PrintString("Delay:");
...
//  }
  ...
  if( ui_selected_item == ITEM_VELOCITY ) {
	SEQ_LCD_FontInit((u8 *)GLCD_FONT_NORMAL_INV);
    SEQ_LCD_PrintString("Velocity Lev:");
	SEQ_LCD_FontInit((u8 *)GLCD_FONT_NORMAL);
  } else {
    SEQ_LCD_FontInit((u8 *)GLCD_FONT_NORMAL);
	SEQ_LCD_PrintString("Velocity Lev:");
...
//  }
  ...
  //SEQ_LCD_PrintSpaces(4);
  if( ui_selected_item == ITEM_FB_VELOCITY ) {
	SEQ_LCD_FontInit((u8 *)GLCD_FONT_NORMAL_INV);
    SEQ_LCD_PrintString("FB Velocity: ");
	SEQ_LCD_FontInit((u8 *)GLCD_FONT_NORMAL);
  } else {
    SEQ_LCD_FontInit((u8 *)GLCD_FONT_NORMAL);
	SEQ_LCD_PrintString("FB Velocity: ");
...
//  }
  ...
  if( ui_selected_item == ITEM_FB_NOTE ) {
	SEQ_LCD_FontInit((u8 *)GLCD_FONT_NORMAL_INV);
...
//  }
  ...
  if( ui_selected_item == ITEM_FB_GATELENGTH ) {
	SEQ_LCD_FontInit((u8 *)GLCD_FONT_NORMAL_INV);
    SEQ_LCD_PrintString("Gate Length: ");
	SEQ_LCD_FontInit((u8 *)GLCD_FONT_NORMAL);
  } else {
    SEQ_LCD_FontInit((u8 *)GLCD_FONT_NORMAL);
	SEQ_LCD_PrintString("Gate Length: ");
...
//  }
  ...
  if( ui_selected_item == ITEM_FB_TICKS ) {
	SEQ_LCD_FontInit((u8 *)GLCD_FONT_NORMAL_INV);
    SEQ_LCD_PrintString("Ticks      : ");
	SEQ_LCD_FontInit((u8 *)GLCD_FONT_NORMAL);
  } else {
    SEQ_LCD_FontInit((u8 *)GLCD_FONT_NORMAL);
	SEQ_LCD_PrintString("Ticks      : ");
