...
static s32 LCD_Handler(u8 high_prio)
{
  ...
  SEQ_LCD_PrintString(" TRCK Fx HUMANIZE");
...
*/
  ///////////////////////////////////////////////////////////////////////////
  ///////////////////////////////////////////////////////////////////////////
  if( ui_selected_item == ITEM_HUMANIZE_VALUE ) {
	SEQ_LCD_FontInit((u8 *)GLCD_FONT_NORMAL_INV);
...
//  }
  ...
  if( ui_selected_item == ITEM_HUMANIZE_NOTE ) {
	SEQ_LCD_FontInit((u8 *)GLCD_FONT_NORMAL_INV);
...
//  }
  ...
  if( ui_selected_item == ITEM_HUMANIZE_VELOCITY ) {
	SEQ_LCD_FontInit((u8 *)GLCD_FONT_NORMAL_INV);
    SEQ_LCD_PrintString("Vel/CC   : ");
	SEQ_LCD_FontInit((u8 *)GLCD_FONT_NORMAL);
  } else {
    SEQ_LCD_FontInit((u8 *)GLCD_FONT_NORMAL);
	SEQ_LCD_PrintString("Vel/CC   : ");
...
//  }
  ...
  if( ui_selected_item == ITEM_HUMANIZE_LENGTH ) {
	SEQ_LCD_FontInit((u8 *)GLCD_FONT_NORMAL_INV);
