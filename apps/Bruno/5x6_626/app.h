...
extern void APP_MIDI_NotifyPackage(adios_midi_port_t port, adios_midi_package_t midi_package);
extern s32 APP_SYSEX_Parser(adios_midi_port_t port, u8 midi_in);
