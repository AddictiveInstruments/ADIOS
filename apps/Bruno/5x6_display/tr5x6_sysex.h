...
extern s32 TR5X6_SYSEX_TimeOut(adios_midi_port_t port);
extern s32 TR5X6_SYSEX_TimeOut_Period(void);

extern s32 TR5X6_SYSEX_Cmd_WriteInfoRequest(void);
extern s32 TR5X6_SYSEX_Cmd_WriteBlockRequest(void);
extern s32 TR5X6_SYSEX_Send_Info(adios_midi_port_t port);
extern s32 TR5X6_SYSEX_Send_UploadReq(adios_midi_port_t port);
extern s32 TR5X6_SYSEX_Send_Block(adios_midi_port_t port);

extern u8 TR5X6_SYSEX_Act(void);
extern s8 TR5X6_SYSEX_Bank_Progression(void);
extern u8 TR5X6_SYSEX_Slot_Progression(void);
extern u8 TR5X6_SYSEX_Slot_Current(void);
extern u8 TR5X6_SYSEX_Bank_Current(void);
extern u8 TR5X6_SYSEX_Cmd_Current(void);
