/*
 * Local ADIOS configuration file - 5x6 ROM one-shot migration tool
 *
 * ==========================================================================
 */
...
// The G070CB has no USB peripheral at all, and adios/adios.mk compiles no USB
// source for the G0 family - so main.c's ADIOS_USB_Init() call has to go, or
