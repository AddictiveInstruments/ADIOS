...
# error "mios32_bsl_boundary.h was not included: this bootloader does not know where the application starts. That header is generated by etc/gen_bsl_boundary.sh, which a project build runs - build through the project, not by hand."
#endif
